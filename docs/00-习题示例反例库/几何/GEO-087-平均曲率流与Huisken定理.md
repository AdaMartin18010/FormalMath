...
external_ids:
  ...
  msc_classification_url: https://mathscinet.ams.org/mathscinet/search/mscdoc.html?code=53E10
references:
  databases:
  - id: wikidata
    type: database
...
本题为研究级难度问题，涉及几何流的深入理论。

**问题**: 证明或推导与平均曲率流与Huisken定理相关的核心定理。
