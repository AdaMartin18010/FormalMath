...
timeline
    ...
    section 早期成就
        1991 : 访问美国多所大学
             : Courant研究所、SUNY等
        1992 : 解决灵魂猜想 (Soul Conjecture)
             : 微分几何重大突破
        1994 : 国际数学家大会邀请报告
        1994 : 证明比较几何中的结果
    section Poincaré猜想
        1995 : 回到斯捷克洛夫研究所
        2002 : 11月：arXiv发布第一篇文章
             : "The entropy formula for the Ricci flow"
        2003 : 3月：第二篇文章
        2003 : 4月：第三篇文章
        2003 : MIT、Stony Brook系列演讲
        2004 : 退出数学界传言
    section 拒绝荣誉
        2006 : 拒绝菲尔兹奖
             : "我与数学界断绝了关系"
...
```mermaid
graph TD
    A[Grigori Perelman] --> B[Yuri Burago<br/>导师]
    A --> C[Mikhail Gromov<br/>学术影响]
    A --> D[Richard Hamilton<br/>Ricci流先驱]
    ...
    F --> F1[Thurston纲领<br/>实现]
    F --> F2[几何与拓扑<br/>统一]

    G --> G1[Kähler-Ricci流<br/>发展]
    G --> G2[Brendle-Schoen<br/>球面定理]
```
