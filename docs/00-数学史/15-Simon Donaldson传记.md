...
timeline
    ...
    section 学术崛起
        ...
        1998 : 伦敦帝国理工学院教授
    section 持续贡献
        1991-1997 : 与Kronheimer合作《四维流形几何学》
        1996 : 皇家学会院士
        1999 : 几何学突破：近复结构与辛几何
        2000s : 规范理论新应用
        2009 : 与Segal合作拓扑场论
        2014 : 获Breakthrough Prize
        2016 : 成为美国院士
```
...
```mermaid
graph TD
    A[Donaldson理论] --> B[Seiberg-Witten理论]
    B --> C[简化计算]
    B --> D[新不变量]
    B --> E[更广泛的应用]

    C --> C1[更容易计算]
    D --> D1[Seiberg-Witten不变量]
    E --> E1[辛几何]
    E --> E2[3-流形]
```
...
```mermaid
graph TD
    A[Simon Donaldson] --> B[Michael Atiyah<br/>导师]
    A --> C[Nigel Hitchin<br/>学术影响]

    A --> D[四维流形理论]
    A --> E[辛几何]
    A --> F[规范理论拓扑]

    D --> D1[Seiberg-Witten<br/>理论发展]
    D --> D2[4-流形分类<br/>问题]

    E --> E1[Gromov-Witten<br/>理论]
    E --> E2[Floer同调]
