...
```mermaid
timeline
    title Jean-Pierre Serre 生平时间线
    section 早年
        1926 : 9月15日出生于法国Bages
             : 药剂师家庭
        1932-1940 : 在Nantes接受初等教育
        1940 : 进入Paris的Lycée de Nîmes
        1942 : 通过Concours Général数学竞赛
        1945 : 进入École Normale Supérieure
             : 导师：Henri Cartan
        1948 : 开始研究生学习
        1950 : 与Josiane结婚
    section 学术崛起
...
```mermaid
graph TD
    A[Jean-Pierre Serre] --> B[Henri Cartan<br/>导师]
    A --> C[代数拓扑<br/>革命]
    A --> D[代数几何<br/>基础]
    A --> E[数论<br/>工具]

    C --> C1[Adams<br/>稳定同伦论]
    C --> C2[Quillen<br/>高阶K理论]

    D --> D1[Grothendieck<br/>概形理论]
    D --> D2[复几何发展]

    E --> E1[Deligne<br/>Weil猜想]
    E --> E2[Langlands<br/>纲领]
    E --> E3[Wiles<br/>费马大定理]
```
