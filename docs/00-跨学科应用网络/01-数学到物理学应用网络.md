...
- [数学到物理学应用网络](#数学到物理学应用网络)
  - [目录](#目录)
  - [一、概述与方法论](#一概述与方法论)
    - [1.1 数学物理的本质](#11-数学物理的本质)
    - [1.2 本文档的方法论框架](#12-本文档的方法论框架)
    - [1.3 五大主干总览](#13-五大主干总览)
  - [二、主干1：经典力学中的数学](#二主干1经典力学中的数学)
    - [2.1 整体网络结构](#21-整体网络结构)
    - [2.2 Newton力学 → 微分方程、向量分析](#22-newton力学--微分方程向量分析)
      - [2.2.1 物理问题描述](#221-物理问题描述)
      - [2.2.2 数学模型构建](#222-数学模型构建)
      - [2.2.3 关键数学定理](#223-关键数学定理)
      - [2.2.4 物理解释](#224-物理解释)
      - [2.2.5 历史发展脉络](#225-历史发展脉络)
    - [2.3 Lagrange力学 → 变分法、流形上的切丛](#23-lagrange力学--变分法流形上的切丛)
      - [2.3.1 物理问题描述](#231-物理问题描述)
      - [2.3.2 数学模型构建](#232-数学模型构建)
      - [2.3.3 关键数学定理](#233-关键数学定理)
      - [2.3.4 物理解释](#234-物理解释)
      - [2.3.5 历史发展脉络](#235-历史发展脉络)
    - [2.4 Hamilton力学 → 辛几何、Poisson括号](#24-hamilton力学--辛几何poisson括号)
      - [2.4.1 物理问题描述](#241-物理问题描述)
      - [2.4.2 数学模型构建](#242-数学模型构建)
      - [2.4.3 关键数学定理](#243-关键数学定理)
      - [2.4.4 物理解释](#244-物理解释)
      - [2.4.5 历史发展脉络](#245-历史发展脉络)
    - [2.5 刚体运动 → 李群SO(3)、角动量](#25-刚体运动--李群so3角动量)
      - [2.5.1 物理问题描述](#251-物理问题描述)
      - [2.5.2 数学模型构建](#252-数学模型构建)
      - [2.5.3 关键数学定理](#253-关键数学定理)
      - [2.5.4 物理解释](#254-物理解释)
      - [2.5.5 历史发展脉络](#255-历史发展脉络)
  - [三、主干2：电磁学中的数学](#三主干2电磁学中的数学)
    - [3.1 整体网络结构](#31-整体网络结构)
    - [3.2 Maxwell方程组 → 向量分析、张量场](#32-maxwell方程组--向量分析张量场)
      - [3.2.1 物理问题描述](#321-物理问题描述)
      - [3.2.2 数学模型构建](#322-数学模型构建)
      - [3.2.3 关键数学定理](#323-关键数学定理)
      - [3.2.4 物理解释](#324-物理解释)
      - [3.2.5 历史发展脉络](#325-历史发展脉络)
    - [3.3 势理论 → 调和函数、Green函数](#33-势理论--调和函数green函数)
      - [3.3.1 物理问题描述](#331-物理问题描述)
      - [3.3.2 数学模型构建](#332-数学模型构建)
      - [3.3.3 关键数学定理](#333-关键数学定理)
      - [3.3.4 物理解释](#334-物理解释)
      - [3.3.5 历史发展脉络](#335-历史发展脉络)
    - [3.4 电磁波 → 波动方程、Fourier分析](#34-电磁波--波动方程fourier分析)
      - [3.4.1 物理问题描述](#341-物理问题描述)
      - [3.4.2 数学模型构建](#342-数学模型构建)
      - [3.4.3 关键数学定理](#343-关键数学定理)
      - [3.4.4 物理解释](#344-物理解释)
      - [3.4.5 历史发展脉络](#345-历史发展脉络)
    - [3.5 规范场 → 主丛、联络、曲率](#35-规范场--主丛联络曲率)
      - [3.5.1 物理问题描述](#351-物理问题描述)
      - [3.5.2 数学模型构建](#352-数学模型构建)
      - [3.5.3 关键数学定理](#353-关键数学定理)
      - [3.5.4 物理解释](#354-物理解释)
      - [3.5.5 历史发展脉络](#355-历史发展脉络)
  - [四、主干3：量子力学中的数学](#四主干3量子力学中的数学)
    - [4.1 整体网络结构](#41-整体网络结构)
    - [4.2 Hilbert空间 → 态空间、算子理论](#42-hilbert空间--态空间算子理论)
      - [4.2.1 物理问题描述](#421-物理问题描述)
      - [4.2.2 数学模型构建](#422-数学模型构建)
      - [4.2.3 关键数学定理](#423-关键数学定理)
      - [4.2.4 物理解释](#424-物理解释)
      - [4.2.5 历史发展脉络](#425-历史发展脉络)
    - [4.3 可观测量 → 自伴算子、谱理论](#43-可观测量--自伴算子谱理论)
      - [4.3.1 物理问题描述](#431-物理问题描述)
      - [4.3.2 数学模型构建](#432-数学模型构建)
      - [4.3.3 关键数学定理](#433-关键数学定理)
      - [4.3.4 物理解释](#434-物理解释)
      - [4.3.5 历史发展脉络](#435-历史发展脉络)
    - [4.4 演化 → 酉群、Stone定理](#44-演化--酉群stone定理)
      - [4.4.1 物理问题描述](#441-物理问题描述)
      - [4.4.2 数学模型构建](#442-数学模型构建)
      - [4.4.3 关键数学定理](#443-关键数学定理)
      - [4.4.4 物理解释](#444-物理解释)
      - [4.4.5 历史发展脉络](#445-历史发展脉络)
    - [4.5 纠缠 → 张量积、纯态与混态](#45-纠缠--张量积纯态与混态)
      - [4.5.1 物理问题描述](#451-物理问题描述)
      - [4.5.2 数学模型构建](#452-数学模型构建)
      - [4.5.3 关键数学定理](#453-关键数学定理)
      - [4.5.4 物理解释](#454-物理解释)
      - [4.5.5 历史发展脉络](#455-历史发展脉络)
  - [五、主干4：相对论中的数学](#五主干4相对论中的数学)
    - [5.1 整体网络结构](#51-整体网络结构)
    - [5.2 狭义相对论 → Lorentz群、Minkowski空间](#52-狭义相对论--lorentz群minkowski空间)
      - [5.2.1 物理问题描述](#521-物理问题描述)
      - [5.2.2 数学模型构建](#522-数学模型构建)
      - [5.2.3 关键数学定理](#523-关键数学定理)
      - [5.2.4 物理解释](#524-物理解释)
      - [5.2.5 历史发展脉络](#525-历史发展脉络)
    - [5.3 广义相对论 → 黎曼几何、Einstein方程](#53-广义相对论--黎曼几何einstein方程)
      - [5.3.1 物理问题描述](#531-物理问题描述)
      - [5.3.2 数学模型构建](#532-数学模型构建)
      - [5.3.3 关键数学定理](#533-关键数学定理)
      - [5.3.4 物理解释](#534-物理解释)
      - [5.3.5 历史发展脉络](#535-历史发展脉络)
    - [5.4 黑洞 → 测地线、事件视界、奇点](#54-黑洞--测地线事件视界奇点)
      - [5.4.1 物理问题描述](#541-物理问题描述)
      - [5.4.2 数学模型构建](#542-数学模型构建)
      - [5.4.3 关键数学定理](#543-关键数学定理)
      - [5.4.4 物理解释](#544-物理解释)
      - [5.4.5 历史发展脉络](#545-历史发展脉络)
  - [六、主干5：统计力学中的数学](#六主干5统计力学中的数学)
    - [6.1 整体网络结构](#61-整体网络结构)
    - [6.2 系综理论 → 概率测度、遍历理论](#62-系综理论--概率测度遍历理论)
      - [6.2.1 物理问题描述](#621-物理问题描述)
      - [6.2.2 数学模型构建](#622-数学模型构建)
      - [6.2.3 关键数学定理](#623-关键数学定理)
      - [6.2.4 物理解释](#624-物理解释)
      - [6.2.5 历史发展脉络](#625-历史发展脉络)
    - [6.3 相变 → 统计场论、重整化群](#63-相变--统计场论重整化群)
      - [6.3.1 物理问题描述](#631-物理问题描述)
      - [6.3.2 数学模型构建](#632-数学模型构建)
      - [6.3.3 关键数学定理](#633-关键数学定理)
      - [6.3.4 物理解释](#634-物理解释)
      - [6.3.5 历史发展脉络](#635-历史发展脉络)
    - [6.4 熵 → 信息论、Boltzmann熵](#64-熵--信息论boltzmann熵)
      - [6.4.1 物理问题描述](#641-物理问题描述)
      - [6.4.2 数学模型构建](#642-数学模型构建)
      - [6.4.3 关键数学定理](#643-关键数学定理)
      - [6.4.4 物理解释](#644-物理解释)
      - [6.4.5 历史发展脉络](#645-历史发展脉络)
  - [七、统一视角与深层联系](#七统一视角与深层联系)
    - [7.1 数学结构的统一](#71-数学结构的统一)
    - [7.2 物理理论层次结构](#72-物理理论层次结构)
    - [7.3 深层数学联系](#73-深层数学联系)
    - [7.4 未来展望](#74-未来展望)
  - [附录：历史年表与人物谱系](#附录历史年表与人物谱系)
    - [关键人物时间线](#关键人物时间线)
    - [重要公式汇集](#重要公式汇集)
      - [经典力学](#经典力学)
      - [电磁学](#电磁学)
  ...
  - [参考文献](#参考文献)
    - [经典教材](#经典教材)
    - [数学参考](#数学参考)
  - [补充内容：数学物理的交叉前沿](#补充内容数学物理的交叉前沿)
    - [A. 数学物理中的对偶性](#a-数学物理中的对偶性)
      - [A.1 电磁对偶性](#a1-电磁对偶性)
      - [A.2 T-对偶性（弦理论）](#a2-t-对偶性弦理论)
      - [A.3 AdS/CFT对偶](#a3-adscft对偶)
    - [B. 可积系统与现代数学](#b-可积系统与现代数学)
      - [B.1 完全可积系统](#b1-完全可积系统)
      - [B.2 孤子与反散射方法](#b2-孤子与反散射方法)
      - [B.3 量子可积性](#b3-量子可积性)
    - [C. 拓扑场论与数学物理](#c-拓扑场论与数学物理)
      - [C.1 Chern-Simons理论](#c1-chern-simons理论)
      - [C.2 拓扑绝缘体](#c2-拓扑绝缘体)
    - [D. 随机矩阵与量子混沌](#d-随机矩阵与量子混沌)
      - [D.1 随机矩阵理论](#d1-随机矩阵理论)
      - [D.2 量子混沌与经典混沌](#d2-量子混沌与经典混沌)
    - [E. 非交换几何与物理](#e-非交换几何与物理)
      - [E.1 标准模型的几何化](#e1-标准模型的几何化)
      - [E.2 弦理论中的非交换性](#e2-弦理论中的非交换性)
    - [F. 信息论与黑洞物理](#f-信息论与黑洞物理)
      - [F.1 黑洞信息悖论](#f1-黑洞信息悖论)
      - [F.2 全息原理](#f2-全息原理)
      - [F.3 ER=EPR](#f3-erepr)
    - [G. 复杂系统与涌现现象](#g-复杂系统与涌现现象)
      - [G.1 涌现与还原论](#g1-涌现与还原论)
      - [G.2 相变的涌现本质](#g2-相变的涌现本质)
      - [G.3 生命与熵](#g3-生命与熵)
  - [数学物理方法论反思](#数学物理方法论反思)
    - [数学在物理中的作用层次](#数学在物理中的作用层次)
    - [物理学对数学的反馈](#物理学对数学的反馈)
    - [未来挑战](#未来挑战)
  - [结语](#结语)
  - [补充：核心公式速查表](#补充核心公式速查表)
    - [数学物理核心公式索引](#数学物理核心公式索引)
      - [微分几何公式](#微分几何公式)
      - [群论公式](#群论公式)
      - [泛函分析公式](#泛函分析公式)
