...
- [p进Hodge理论深度版 / p-adic Hodge Theory (Advanced)](#p进hodge理论深度版--p-adic-hodge-theory-advanced)
  - [目录](#目录)
  - [1. 深入概念 / Deep Concepts](#1-深入概念--deep-concepts)
    - [1.1 p进周期环](#11-p进周期环)
      - [1.1.1 Fontaine周期环](#111-fontaine周期环)
      - [1.1.2 环的性质](#112-环的性质)
    - [1.2 比较定理](#12-比较定理)
      - [1.2.1 de Rham比较定理](#121-de-rham比较定理)
      - [1.2.2 晶体比较定理](#122-晶体比较定理)
      - [1.2.3 半稳定比较定理](#123-半稳定比较定理)
    - [1.3 (phi, Gamma)-模](#13-phi-gamma-模)
      - [1.3.1 定义与构造](#131-定义与构造)
      - [1.3.2 与p进表示的等价](#132-与p进表示的等价)
      - [1.3.3 扩展与上同调](#133-扩展与上同调)
  - [2. 现代观点 / Modern Perspectives](#2-现代观点--modern-perspectives)
    - [2.1 相对p进Hodge理论](#21-相对p进hodge理论)
      - [2.1.1 动机与背景](#211-动机与背景)
      - [2.1.2 Scholze的方法](#212-scholze的方法)
      - [2.1.3 应用](#213-应用)
    - [2.2 完美胚空间与p进Hodge理论](#22-完美胚空间与p进hodge理论)
      - [2.2.1 完美胚提升](#221-完美胚提升)
      - [2.2.2 几乎纯性](#222-几乎纯性)
    - [2.3 无穷范畴视角](#23-无穷范畴视角)
      - [2.3.1 导出p进Hodge理论](#231-导出p进hodge理论)
      - [2.3.2 滤过与谱序列](#232-滤过与谱序列)
  - [3. 研究前沿 / Research Frontiers](#3-研究前沿--research-frontiers)
    - [3.1 p进Simpson对应](#31-p进simpson对应)
      - [3.1.1 经典Simpson对应回顾](#311-经典simpson对应回顾)
      - [3.1.2 p进Simpson对应](#312-p进simpson对应)
    - [3.2 黎曼-Hilbert对应](#32-黎曼-hilbert对应)
      - [3.2.1 经典黎曼-Hilbert](#321-经典黎曼-hilbert)
      - [3.2.2 p进黎曼-Hilbert](#322-p进黎曼-hilbert)
    - [3.3 与Langlands纲领的联系](#33-与langlands纲领的联系)
      - [3.3.1 p进Langlands对应](#331-p进langlands对应)
      - [3.3.2 完美胚空间的几何化](#332-完美胚空间的几何化)
...
1. **Scholze, P.** (2012). *Perfectoid Spaces*. Publ. Math. IHES.

2. **Scholze, P.** (2013). *p-adic Hodge theory for rigid-analytic varieties*. Forum Math. Pi.

3. **Kedlaya, K. & Liu, R.** (2015). *Relative p-adic Hodge theory: Foundations*. Astérisque.

### 前沿研究

1. **Liu, R. & Zhu, X.** (2017). *Rigidity and a Riemann-Hilbert correspondence for p-adic local systems*. Inventiones Math.

2. **Diao, H., Lan, K-W., Liu, R. & Zhu, X.** (2019). *Logarithmic Riemann-Hilbert correspondences for rigid varieties*. ArXiv.

3. **Anschütz, J. & Le Bras, A-C.** (2020). *Prismatic Dieudonne theory*. ArXiv.

### 综述文章

1. **Brinon, O. & Conrad, B.** (2009). *CMI Summer School notes on p-adic Hodge Theory*.

2. **Morrow, M.** (2019). *The Fargues-Fontaine curve and p-adic Hodge theory*. Proceedings ICM.

3. **Fargues, L. & Fontaine, J-M.** (2018). *Courbes et fibres vectoriels en theorie de Hodge p-adique*. Astérisque.
