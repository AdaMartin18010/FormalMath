...
5. **Hartshorne, R.** - *Algebraic Geometry* (1977)
   - 第III章层上同调的标准参考

6. **Milne, J.S.** - *Étale Cohomology* (1980)
   - 平展上同调的权威著作

7. **Freitag, E. & Kiehl, R.** - *Étale Cohomology and the Weil Conjecture* (1988)
   - Weil猜想的完整证明

### 高级专题

8. **Deligne, P.** - *Théorie de Hodge I, II, III* (1971-1974)
   - 混合Hodge结构的奠基论文

9. **Beilinson, A., Bernstein, J. & Deligne, P.** - *Faisceaux Pervers* (1982)
   - 反常层的开创性工作

10. **Goresky, M. & MacPherson, R.** - *Stratified Morse Theory* (1988)
    - 相交同调的拓扑基础

### 前沿研究

11. **Scholze, P.** - *$p$-adic Hodge Theory for Rigid-Analytic Varieties* (2013)
    - 新$p$-adic Hodge理论框架

12. **Bhatt, B.** - *Specializing Varieties and Their Cohomology* (2021)
    - 原始上同调与奇异上同调的联系

13. **Lurie, J.** - *Higher Algebra* (2017)
    - 高阶代数几何的层论
