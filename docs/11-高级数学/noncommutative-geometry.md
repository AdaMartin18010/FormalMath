...
external_ids:
  msc_classification_url: https://mathscinet.ams.org/mathscinet/search/mscdoc.html?code=58B34
---
...
5. **Wegge-Olsen, N.E.** (1993)
    - *K-Theory and C*-Algebras*
    - Oxford University Press
    - C*-代数K-理论的教材

6. **Blackadar, B.** (1998, 2nd ed. 2024)
...
2. **Connes, A. & Chamseddine, A.H.** (1997, 2006)
    - *The Spectral Action Principle*
    - Communications in Mathematical Physics
    - 谱作用原理的提出和发展

3. **Tsygan, B.** (1983, 1986)
...
9. **Kaledin, D.** (2007, 2008)
    - *Non-Commutative Cartier Operator and Hodge-to-de Rham Degeneration*
    - Cyclic Homology with Coefficients
    - 非交换Hodge理论

10. **Tabuada, G.** (2005-2015)
    - *Noncommutative Motives* (系列论文)
    - 非交换动机理论的系统发展

### 5.4 在线资源 / Online Resources

1. **Connes' Website** - http://www.alainconnes.org/[需更新[需更新]]
    - Alain Connes的论文和讲义

2. **Noncommutative Geometry Blog** - Various contributors
    - 非交换几何研究者的博客和讨论

3. **ArXiv Tag: Operator Algebras** - https://arxiv.org/list/math.OA/recent
    - 算子代数最新论文

4. **ArXiv Tag: K-Theory and Homology** - https://arxiv.org/list/math.KT/recent
    - K-理论和同调最新论文

5. **ArXiv Tag: Quantum Algebra** - https://arxiv.org/list/math.QA/recent
    - 量子代数和量子群最新论文

6. **nLab: Noncommutative Geometry** - https://ncatlab.org/nlab/show/noncommutative+geometry
    - 非交换几何的综合wiki页面

7. **MathOverflow: Noncommutative Geometry** - https://mathoverflow.net/questions/tagged/noncommutative-geometry
    - 非交换几何相关问题讨论

8. **Operator Algebras Resources** - Various university websites
    - 算子代数和C*-代数的学习资源

9. **Noncommutative Geometry Network** - https://www.noncommutativegeometry.net/[需更新[需更新]]
    - 非交换几何研究网络
