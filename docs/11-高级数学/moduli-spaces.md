...
1. **Deligne, P. & Mumford, D.** - *The Irreducibility of the Space of Curves of Given Genus* (1969)
   - $\overline{\mathcal{M}}_g$的奠基论文

2. **Fulton, W. & Pandharipande, R.** - *Notes on Stable Maps and Quantum Cohomology* (1997)
   - 稳定映射与GW理论的综述

3. **Huybrechts, D. & Lehn, M.** - *The Geometry of Moduli Spaces of Sheaves* (1996, 2nd ed. 2010)
   - 层模空间的几何

### 栈与导出几何

1. **Laumon, G. & Moret-Bailly, L.** - *Champs Algébriques* (2000)
   - 代数栈的权威著作

2. **Olsson, M.** - *Algebraic Spaces and Stacks* (2016)
   - 现代栈理论的教材

3. **Toën, B.** - *Derived Algebraic Geometry* (2014 EMS Surveys)
   - 导出代数几何的综述

### 前沿研究

1. **Gross, M., Hacking, P., Keel, S., & Kontsevich, M.** - *Canonical Bases for Cluster Algebras* (2018)
    - Log Calabi-Yau簇的模空间

2. **Abramovich, D., Chen, Q., Gillam, D., et al.** - *Logarithmic Geometry and Moduli Spaces*
    - 对数几何与模空间

3. **Bridgeland, T.** - *Stability Conditions on Triangulated Categories* (2007)
    - 稳定性条件的奠基论文

4. **Joyce, D.** - *Kuranishi Spaces and Symplectic Geometry* (2015)
    - 导出/Kuranishi模空间

### 镜像对称

1. **Gross, M., Hacking, P., & Keel, S.** - *Mirror Symmetry for Log Calabi-Yau Surfaces I* (2015)
    - Log CY曲面的SYZ构造

2. **Auroux, D.** - *Mirror Symmetry and $T$-Duality in the Complement of an Anticanonical Divisor* (2007)
    - 开SYZ构造
...
- [Mirror Symmetry Seminar](https://math.mit.edu/) - Auroux的镜像对称讲义
