...
- **内积**: $\langle \psi, \phi \rangle$ 满足
  ...
  - 正定性: $\langle \psi, \psi \rangle \geqq 0$，且 $\langle \psi, \psi \rangle = 0$ 当且仅当 $\psi = 0$
...
- $|\langle \psi, \phi \rangle|^2 \leqq \langle \psi, \psi \rangle \langle \phi, \phi \rangle$
...
- $\Delta A \Delta B \geqq \frac{1}{2}|\langle [A, B] \rangle|$
