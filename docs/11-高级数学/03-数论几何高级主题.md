---
title: 11.3 数论几何高级主题 / Advanced Topics in Arithmetic Geometry
msc_primary: 11R39
msc_secondary:
- 13Dxx
- 14D24
...
- [11.3 数论几何高级主题 / Advanced Topics in Arithmetic Geometry](#113-数论几何高级主题--advanced-topics-in-arithmetic-geometry)
  - [目录](#目录)
  - [11.3.1 概述 / Overview (编号: B.11.03.01)](#1131-概述--overview-编号-b110301)
    - [11.3.1.1 核心概念](#11311-核心概念)
  - [11.3.2 算术几何 / Arithmetic Geometry (编号: B.11.03.02)](#1132-算术几何--arithmetic-geometry-编号-b110302)
  ...
  - [11.3.3 p进分析 / p-adic Analysis (编号: B.11.03.03)](#1133-p进分析--p-adic-analysis-编号-b110303)
  ...
  - [11.3.4 朗兰兹纲领 / Langlands Program (编号: B.11.03.04)](#1134-朗兰兹纲领--langlands-program-编号-b110304)
  ...
  - [11.3.5 椭圆曲线 / Elliptic Curves (编号: B.11.03.05)](#1135-椭圆曲线--elliptic-curves-编号-b110305)
  ...
  - [11.3.6 形式化实现 / Formal Implementation (编号: B.11.03.06)](#1136-形式化实现--formal-implementation-编号-b110306)
...
- 与[代数数论](../05-数论/02-代数数论/00-README.md)的理论框架相联系
- 与[代数几何](../04-几何与拓扑/01-几何学基础/05-代数几何.md)的几何方法相呼应
- 与[解析数论](../05-数论/03-解析数论/00-README.md)的分析工具相结合
...
- [代数数论](../05-数论/02-代数数论/00-README.md)
- [代数几何](../04-几何与拓扑/01-几何学基础/05-代数几何.md)
- [解析数论](../05-数论/03-解析数论/00-README.md)
