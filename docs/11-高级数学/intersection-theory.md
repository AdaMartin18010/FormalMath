...
1. **Semple, J.G. & Roth, L.** - *Introduction to Algebraic Geometry* (1949)
   - 经典计数几何的详细讨论

2. **Griffiths, P. & Harris, J.** - *Principles of Algebraic Geometry* (1978)
   - 复几何观点的周环讨论

3. **Borel, A. & Haefliger, A.** - *La classe d'homologie fondamentale d'un espace analytique* (1961)
   - 同调交截的基础

### 现代专题

1. **Behrend, K. & Fantechi, B.** - *The Intrinsic Normal Cone* (1997)
   - 虚拟基本类的奠基论文

2. **Behrend, K.** - *Gromov-Witten Invariants in Algebraic Geometry* (1997)
   - GW不变量的代数构造

3. **Kontsevich, M. & Manin, Y.** - *Gromov-Witten Classes, Quantum Cohomology, and Enumerative Geometry* (1994)
   - GW理论的公理化

### 前沿研究

1. **Gross, M., Siebert, B.** - *Logarithmic Gromov-Witten Invariants* (2013)
    - 对数GW理论

2. **Abramovich, D., Chen, Q., Gillam, D., et al.** - *Logarithmic Geometry and Moduli Spaces*
    - 对数几何综述

3. **Levine, M. & Morel, F.** - *Algebraic Cobordism* (2007)
    - 代数cobordism理论

4. **Maulik, D., Nekrasov, N., Okounkov, A., & Pandharipande, R.** - *Gromov-Witten Theory and Donaldson-Thomas Theory I* (2006)
    - GW/DT对应
