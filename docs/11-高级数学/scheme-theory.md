...
5. **Mumford, D.** - *Lectures on Curves on an Algebraic Surface* (1966)
   - 模空间与相交理论的早期经典

6. **Fulton, W.** - *Intersection Theory* (1984)
   - 相交理论的权威著作

7. **Katz, N. & Mazur, B.** - *Arithmetic Moduli of Elliptic Curves* (1985)
   - 模形式的模空间理论

### 前沿研究

8. **Scholze, P.** - *Perfectoid Spaces* (2012), Publ. Math. IHÉS
   - Perfectoid空间的奠基论文

9. **Bhatt, B. & Scholze, P.** - *The Pro-Étale Topology for Schemes* (2015)
   - 新的拓扑框架及其应用

10. **Abramovich, D. et al.** - *Logarithmic Geometry and Moduli Spaces*
    - 对数几何的综述与应用
