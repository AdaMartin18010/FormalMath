...
external_ids:
  ...
  msc_classification_url: https://mathscinet.ams.org/mathscinet/search/mscdoc.html?code=18N60
references:
  databases:
  - id: wikidata
    type: database
...
1. **nLab** - https://ncatlab.org/nlab/show/higher+category+theory
    - 关于高阶范畴论的综合wiki

2. **Kerodon** - https://kerodon.net/[需更新[需更新]]
    - Jacob Lurie维护的无穷-范畴论在线资源

3. **MathOverflow** - https://mathoverflow.net/questions/tagged/higher-category-theory
    - 高阶范畴论相关问题讨论

4. **Lurie's Website** - https://www.math.ias.edu/~lurie/[需更新[需更新]]
    - 所有论文和著作的原始版本

5. **Riehl's Website** - https://math.jhu.edu/~eriehl/[需更新[需更新]]
    - Emily Riehl的讲义和补充材料

6. **GitHub: agda-unimath** - https://github.com/UniMath/agda-unimath
    - Agda中无穷-范畴论的形式化

7. **GitHub: rzk** - https://github.com/rzk-lang/rzk
    - 合成无穷-范畴的证明助手
