...
6. **UFP (Univalent Foundations Program)** (2020)
   - *Symmetry Book* (进行中)
   - 使用HoTT重新表述群论和对称性

7. **Coquand, T., Huber, S., & Mörtberg, A.** (2018)
...
8. **Angiuli, C., Cavallo, E., Mörtberg, A., & Zeuner, M.** (2021)
   - *Internalizing Representation Independence with Univalence*
   - POPL 2021
   - 单值公理在软件验证中的应用

9. **Riehl, E. & Shulman, M.** (2017)
   - *A Type Theory for Synthetic ∞-Categories*
   - 高阶范畴论的类型论基础

10. **Schreiber, U. & Shulman, M.** (2014)
...
12. **Licata, D. & Finster, E.** (2014)
    - *Eilenberg-MacLane Spaces in Homotopy Type Theory*
    - LICS 2014
    - 在HoTT中构造Eilenberg-MacLane空间

13. **Sozeau, M. & Tabareau, N.** (2019)
