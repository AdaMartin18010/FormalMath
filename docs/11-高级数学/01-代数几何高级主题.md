---
title: 11.1 代数几何高级主题 / Advanced Topics in Algebraic Geometry
msc_primary: 18Gxx
msc_secondary:
- 46Cxx
- 13Dxx
...
- 与[代数几何](../04-几何与拓扑/01-几何学基础/05-代数几何.md)的基础理论相联系
- 与[同调论](../04-几何与拓扑/03-拓扑学内容/05-同调论.md)的理论框架相呼应
- 与[范畴论](../02-代数结构/02-范畴论/00-README.md)的抽象方法相结合
