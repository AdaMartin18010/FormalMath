...
- [11. 算术几何 / Arithmetic Geometry](#11-算术几何--arithmetic-geometry)
  - [目录](#目录)
  - [11.1 概述 / Overview (编号: B.11.11.01)](#111-概述--overview-编号-b111101)
    - [11.1.1 核心概念](#1111-核心概念)
    - [11.1.2 历史发展](#1112-历史发展)
  - [11.2 代数几何基础 / Algebraic Geometry Foundations (编号: B.11.11.02)](#112-代数几何基础--algebraic-geometry-foundations-编号-b111102)
  ...
  - [11.3 数论基础 / Number Theory Foundations (编号: B.11.11.03)](#113-数论基础--number-theory-foundations-编号-b111103)
  ...
  - [11.4 算术几何核心 / Core of Arithmetic Geometry (编号: B.11.11.04)](#114-算术几何核心--core-of-arithmetic-geometry-编号-b111104)
  ...
  - [11.5 椭圆曲线 / Elliptic Curves (编号: B.11.11.05)](#115-椭圆曲线--elliptic-curves-编号-b111105)
  ...
  - [11.6 模形式 / Modular Forms (编号: B.11.11.06)](#116-模形式--modular-forms-编号-b111106)
  ...
  - [11.7 朗兰兹纲领 / Langlands Program (编号: B.11.11.07)](#117-朗兰兹纲领--langlands-program-编号-b111107)
  ...
  - [11.8 形式化实现 / Formal Implementation (编号: B.11.11.08)](#118-形式化实现--formal-implementation-编号-b111108)
...
## 11.1 概述 / Overview (编号: B.11.11.01)
...
## 11.2 代数几何基础 / Algebraic Geometry Foundations (编号: B.11.11.02)
...
## 11.3 数论基础 / Number Theory Foundations (编号: B.11.11.03)
...
**基本定理**: 存在一一对应：
$$\{\text{中间域}\} \leqqftrightarrow \{\text{子群}\}$$

## 11.4 算术几何核心 / Core of Arithmetic Geometry (编号: B.11.11.04)
...
**ℓ进上同调**:
$$H^i_{\text{ét}}(X, \mathbb{Z}_\ell) = \lim_{\leqqftarrow n} H^i_{\text{ét}}(X, \mathbb{Z}/\ell^n\mathbb{Z})$$
...
## 11.5 椭圆曲线 / Elliptic Curves (编号: B.11.11.05)
...
## 11.6 模形式 / Modular Forms (编号: B.11.11.06)
...
$$E \leqqftrightarrow f$$

其中 $L(E, s) = L(f, s)$。

## 11.7 朗兰兹纲领 / Langlands Program (编号: B.11.11.07)

### 11.7.1 朗兰兹对应 / Langlands Correspondence

**朗兰兹对应**: 设 $F$ 是数域，则存在对应：
$$\text{Galois Representations} \leqqftrightarrow \text{Automorphic Representations}$$

**具体形式**:
$$\rho : G_F \rightarrow GL_n(\mathbb{C}) \leqqftrightarrow \pi : GL_n(\mathbb{A}_F) \rightarrow \text{Automorphic}$$

### 11.7.2 几何朗兰兹 / Geometric Langlands

**几何朗兰兹对应**: 设 $X$ 是复代数曲线，$G$ 是复约化群，则：
$$\mathcal{D}^b(\text{Bun}_G) \leqqftrightarrow \mathcal{D}^b(\text{LocSys}_G)$$
...
## 11.8 形式化实现 / Formal Implementation (编号: B.11.11.08)
