---
title: 11.10 朗兰兹纲领 / Langlands Program
msc_primary: '11
...
**重大突破**：2024年末，Sam Raskin（耶鲁大学）与合作者发布了一份超过**900页**的手稿，解决了几何朗兰兹纲领的一个主要部分。

**关键信息**：

| 项目 | 内容 |
|------|------|
| **主要贡献者** | Sam Raskin（耶鲁大学）及其合作者 |
| **手稿长度** | 900+页 |
| **完成时间** | 2024年末 |
| **研究领域** | 几何表示论 |
...
**与Fields Medal 2026的关系**：
Sam Raskin被认为是2026年Fields Medal的热门候选人之一，这一突破性工作极大地增加了他的获奖可能性。

**参考文献**：
- Raskin, S. et al. *Geometric Langlands Correspondence* (手稿, 2024)
- 相关报道：VnExpress, 2026年3月

---

### Fields Medal 2026相关候选人

| 候选人 | 机构 | 与朗兰兹纲领的关系 |
|--------|------|-------------------|
| **Sam Raskin** | 耶鲁大学 | 几何朗兰兹纲领900页证明 |
| **Jack Thorne** | 剑桥大学 | 代数数论、朗兰兹纲领新函子性 |
