---
title: 11.17 高阶代数几何 / Higher Algebraic Geometry
msc_primary: 00A99
msc_secondary:
- 16A99
- 00A99
...
---
msc_primary: "18Gxx"
msc_secondary: ['16-XX', '13Dxx', '14Hxx']
---
...
- **与代数几何**: 传统代数几何的推广，将概形、层与上同调提升到导出、无穷与谱层面。
- **与同伦论**: 同伦论在代数几何中的应用，通过同伦范畴、谱与同伦极限重写几何构造。
- **与范畴论**: 无穷范畴理论的应用，为导出栈、谱栈、无穷栈提供统一的抽象语言。
- **与拓扑学**: 拓扑学在代数几何中的应用，特别是稳定同伦理论、层状拓扑与拓扑场论中的空间–谱对应。
- **与现代数论前沿**: 通过自守形式、L-函数、Shimura 簇与动机理论，将高阶代数几何嵌入朗兰兹纲领与算术几何框架（参见 `18-现代数论前沿.md`、`10-朗兰兹纲领.md`）。
- **与现代拓扑学前沿**: 谱代数几何和同伦代数几何与高阶同伦论、代数 K 理论、稳定同伦范畴等主题形成自然桥梁（参见 `19-现代拓扑学前沿.md`、`08-代数K理论.md`、`07-高阶同伦论.md`）。
- **与数学物理高级主题**: 在弦论、拓扑场论、量子场论等领域，高阶代数几何提供了对“空间”“场”“态”的谱化与同伦化建模（参见 `09-数学物理高级主题-扩展版.md`）。
- **与形式化与人工智能数学**: 通过同伦类型论、依值类型和证明助理，将高阶代数几何中的无穷结构形式化，为自动推理与机器证明提供实验场（参见 `15-同伦类型论.md`、`33-人工智能数学-深化版.md`）。
