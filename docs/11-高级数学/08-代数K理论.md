---
title: 11.8 代数K理论 / Algebraic K-Theory
msc_primary: 55Pxx
msc_secondary:
- 20-XX
- 55Qxx
...
- [11.8 代数K理论 / Algebraic K-Theory](#118-代数k理论--algebraic-k-theory)
  - [目录](#目录)
  - [11.8.1 概述 / Overview (编号: B.11.08.01)](#1181-概述--overview-编号-b110801)
    - [11.08.1.1 核心概念](#110811-核心概念)
    - [11.08.1.2 历史背景](#110812-历史背景)
    - [11.08.1.3 与拓扑K理论的关系](#110813-与拓扑k理论的关系)
  - [11.8.2 K0群 / K0 Groups (编号: B.11.08.02)](#1182-k0群--k0-groups-编号-b110802)
  ...
  - [11.8.3 K1群 / K1 Groups (编号: B.11.08.03)](#1183-k1群--k1-groups-编号-b110803)
  ...
  - [11.8.4 K2群 / K2 Groups (编号: B.11.08.04)](#1184-k2群--k2-groups-编号-b110804)
  ...
  - [11.8.5 高阶K群 / Higher K-Groups (编号: B.11.08.05)](#1185-高阶k群--higher-k-groups-编号-b110805)
  ...
  - [11.8.6 代数K理论的应用 / Applications of Algebraic K-Theory (编号: B.11.08.06)](#1186-代数k理论的应用--applications-of-algebraic-k-theory-编号-b110806)
  ...
  - [11.8.7 现代代数K理论 / Modern Algebraic K-Theory (编号: B.11.08.07)](#1187-现代代数k理论--modern-algebraic-k-theory-编号-b110807)
  ...
  - [11.8.8 形式化实现 / Formal Implementation (编号: B.11.08.08)](#1188-形式化实现--formal-implementation-编号-b110808)
...
## 11.8.1 概述 / Overview (编号: B.11.08.01)
...
## 11.8.2 K0群 / K0 Groups (编号: B.11.08.02)
...
### 11.8.2.2 投射模 / Projective Modules
...
## 11.8.3 K1群 / K1 Groups (编号: B.11.08.03)
...
## 11.8.4 K2群 / K2 Groups (编号: B.11.08.04)
...
## 11.8.5 高阶K群 / Higher K-Groups (编号: B.11.08.05)
...
## 11.8.6 代数K理论的应用 / Applications of Algebraic K-Theory (编号: B.11.08.06)
...
## 11.8.7 现代代数K理论 / Modern Algebraic K-Theory (编号: B.11.08.07)
...
## 11.8.8 形式化实现 / Formal Implementation (编号: B.11.08.08)
...
- **[代数几何](../04-几何与拓扑/01-几何学基础/05-代数几何.md)**: 向量丛和示性类理论
- **[数论](../05-数论/00-README.md)**: 代数数论和类域论
- **[拓扑学](../04-几何与拓扑/03-拓扑学内容.md)**: 拓扑K理论和同伦论
- **[同伦论](../04-几何与拓扑/03-拓扑学内容/04-同伦论.md)**: 同伦K理论和稳定K理论
...
- [数论](../05-数论/00-README.md)
- [拓扑学](../04-几何与拓扑/03-拓扑学内容.md)
- [同伦论](../04-几何与拓扑/03-拓扑学内容/04-同伦论.md)
- [无穷范畴理论](06-无穷范畴理论.md)
