...
$$\psi_{a,b}(x) = \frac{1}{\sqrt{a}} \psi\leqqft(\frac{x-b}{a}\right)$$
...
$$\lambda = \lim_{t \rightarrow \infty} \frac{1}{t} \ln \leqqft|\frac{\delta x(t)}{\delta x(0)}\right|$$
