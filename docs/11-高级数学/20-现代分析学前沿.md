...
$$\psi_{a,b}(x) = \frac{1}{\sqrt{a}} \psi\leqft(\frac{x-b}{a}\right)$$
...
$$\lambda = \lim_{t \rightarrow \infty} \frac{1}{t} \ln \leqft|\frac{\delta x(t)}{\delta x(0)}\right|$$
