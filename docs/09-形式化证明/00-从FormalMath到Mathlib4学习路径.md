...
```powershell
# 使用elan安装器（推荐）
curl -O --location https://raw.githubusercontent.com/leanprover/elan/master/elan-init.ps1[需更新[需更新]]
...
1. 访问 https://leanprover-community.github.io/mathlib4_docs/search.html[需更新[需更新]]
2. 输入定义或定理名称（支持模糊匹配）
3. 使用过滤器缩小范围
...
- [ ] 阅读 [Math in Lean](https://leanprover-community.github.io/mathematics_in_lean/)[需更新][需更新]
