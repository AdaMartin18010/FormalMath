...
references:
  ...
  - title: 'Concrete Mathematics: A Foundation for Computer Science'
    ...
    isbn: '9780131558362'
external_ids:
  msc_classification_url: https://mathscinet.ams.org/mathscinet/search/mscdoc.html?code=68T15
---
msc_primary: "68T15"
msc_secondary: ['03-00', '03B70']
---
...
| 概念 | Mathlib4模块 | 对应内容 |
|------|-------------|----------|
| 自然演绎 | `Mathlib.Logic.Basic` | 逻辑连接词的定义 |
| 命题逻辑 | `Mathlib.Logic.Function` | 逻辑等价与蕴含 |
| 哥德尔编码 | `Mathlib.Logic.Encodable` | 可编码类型 |
| 不完备性 | `Mathlib.Logic.Godel.Incompleteness` | 哥德尔定理框架 |
| 集合论 | `Mathlib.SetTheory.Cardinal` | 基数理论 |
| 康托尔定理 | `Mathlib.SetTheory.Cardinal.Basic` | `Cardinal.cantor` |

### 核心定理对应

| 定理名称 | 本项目位置 | Mathlib4位置 | 状态 |
|----------|-----------|--------------|------|
| **哥德尔不完备定理** | 第1.2节 | `godel_first_incompleteness` | 🔄 部分对齐 |
| **康托尔对角线定理** | 第1.2节 | `Cardinal.cantor` | ✅ 已对齐 |
| **完备性定理** | 第1.1节 | `FirstOrder.Language.Theory.isComplete_iff` | 🔄 部分对齐 |
| **切消定理** | 第1.3节 | - | ⏳ 待开发 |

### 形式化代码

- **哥德尔不完备定理**: [Lean4代码](Lean4/GodelIncompleteness.lean)
- **康托尔对角线定理**: [Lean4代码](Lean4/CantorDiagonal.lean)
...
theorem cantor_theorem {A : Type u} (f : A → Set A) : ¬Surjective f := by
  intro h_surj
  let D : Set A := {x | x ∉ f x}

  rcases h_surj D with ⟨d, hd⟩
  by_cases h : d ∈ D
  · have : d ∉ f d := by simpa [D] using h
    rw [hd] at this
    contradiction
  · have : d ∈ D := by
      simp [D]
...
11. Mathlib4 Documentation. <https://leanprover-community.github.io/mathlib4_docs/[需更新[需更新]]>
12. Mathlib4 GitHub Repository. <https://github.com/leanprover-community/mathlib4>
