...
external_ids:
  wikipedia_url: https://en.wikipedia.org/wiki/P-adic_Langlands_program
  stacks_search_url: https://stacks.math.columbia.edu/search?query=p%E8%BF%9BLanglands
  nlab_url: https://ncatlab.org/nlab/show/p-adic+Langlands+program
---
msc_primary: "00A99"
msc_secondary: ['00-00']
---
