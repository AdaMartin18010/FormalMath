...
|------|-----------|----------|----------|----------|
| $G$ | `G` | 群 | group | $(G, \cdot)$ |
| $H \leqqq G$ | `H \leqqq G` | 子群 | subgroup | $H \leqqq G$ |
...
```latex
% 正确：变量命名一致
Let $G$ be a group and $H \leqqq G$ be a subgroup.
