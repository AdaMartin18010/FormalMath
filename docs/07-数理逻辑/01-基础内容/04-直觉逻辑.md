...
- [直觉逻辑](#直觉逻辑)
  - 目录 / Table of Contents
  - [概述 (编号: B.07.04.01)](#概述-编号-b070401)
  - [历史背景 (编号: B.07.04.02)](#历史背景-编号-b070402)
...
- [类型论](./00-README.md) - 类型论与直觉逻辑的对应关系
- [构造性数学](./04-直觉逻辑.md) - 基于直觉逻辑的构造性数学
...
- [Stanford Encyclopedia of Philosophy: Intuitionistic Logic](https://plato.stanford.edu/entries/logic-intuitionistic/)[需更新][需更新]
