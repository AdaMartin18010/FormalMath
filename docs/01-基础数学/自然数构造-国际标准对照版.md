...
- [自然数构造 - 国际标准对照版 / Natural Number Construction - International Standard Comparison](#自然数构造---国际标准对照版-natural-number-construction---international-standard-comparison)
  ...
  - [🏗️ 自然数构造方法 / Natural Number Construction Methods / Méthodes de construction des nombres naturels / Methoden zur Konstruktion natürlicher Zahlen](#自然数构造方法-natural-number-construction-methods-méthodes-de-construction-des-nombres-naturels-methoden-zur-konstruktion-natürlicher-zahlen)
