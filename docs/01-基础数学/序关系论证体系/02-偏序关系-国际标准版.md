...
偏序集是一个有序对 $(A, \leqqq)$，其中 $A$ 是一个集合，$\leqqq$ 是 $A$ 上的偏序关系。

A partially ordered set is an ordered pair $(A, \leqqq)$, where $A$ is a set and $\leqqq$ is a partial order relation on $A$.
...
在偏序集 $(A, \leqqq)$ 中，如果 $a \leqqq b$ 且 $b \leqqq a$，则 $a = b$。

In a partially ordered set $(A, \leqqq)$, if $a \leqqq b$ and $b \leqqq a$, then $a = b$.
...
在偏序集 $(A, \leqqq)$ 中，如果 $a \leqqq b$ 且 $b \leqqq c$，则 $a \leqqq c$。

In a partially ordered set $(A, \leqqq)$, if $a \leqqq b$ and $b \leqqq c$, then $a \leqqq c$.
...
设 $(A, \leqqq)$ 是偏序集，$S \subseteq A$，元素 $m \in S$ 称为 $S$ 的最大元，如果：
$\forall x \in S(x \leqqq m)$

Let $(A, \leqqq)$ be a partially ordered set, $S \subseteq A$, an element $m \in S$ is called a maximum element of $S$ if:
$\forall x \in S(x \leqqq m)$

**定义 2.2** (最小元) / **Definition 2.2** (Minimum Element)

设 $(A, \leqqq)$ 是偏序集，$S \subseteq A$，元素 $m \in S$ 称为 $S$ 的最小元，如果：
$\forall x \in S(m \leqqq x)$

Let $(A, \leqqq)$ be a partially ordered set, $S \subseteq A$, an element $m \in S$ is called a minimum element of $S$ if:
$\forall x \in S(m \leqqq x)$
...
设 $(A, \leqqq)$ 是偏序集，$S \subseteq A$，元素 $m \in S$ 称为 $S$ 的极大元，如果：
$\forall x \in S(m \leqqq x \rightarrow m = x)$

Let $(A, \leqqq)$ be a partially ordered set, $S \subseteq A$, an element $m \in S$ is called a maximal element of $S$ if:
$\forall x \in S(m \leqqq x \rightarrow m = x)$

**定义 2.4** (极小元) / **Definition 2.4** (Minimal Element)

设 $(A, \leqqq)$ 是偏序集，$S \subseteq A$，元素 $m \in S$ 称为 $S$ 的极小元，如果：
$\forall x \in S(x \leqqq m \rightarrow m = x)$

Let $(A, \leqqq)$ be a partially ordered set, $S \subseteq A$, an element $m \in S$ is called a minimal element of $S$ if:
$\forall x \in S(x \leqqq m \rightarrow m = x)$
...
设 $(A, \leqqq)$ 是偏序集，$S \subseteq A$，元素 $u \in A$ 称为 $S$ 的上界，如果：
$\forall x \in S(x \leqqq u)$

Let $(A, \leqqq)$ be a partially ordered set, $S \subseteq A$, an element $u \in A$ is called an upper bound of $S$ if:
$\forall x \in S(x \leqqq u)$

**定义 2.6** (下界) / **Definition 2.6** (Lower Bound)

设 $(A, \leqqq)$ 是偏序集，$S \subseteq A$，元素 $l \in A$ 称为 $S$ 的下界，如果：
$\forall x \in S(l \leqqq x)$

Let $(A, \leqqq)$ be a partially ordered set, $S \subseteq A$, an element $l \in A$ is called a lower bound of $S$ if:
$\forall x \in S(l \leqqq x)$
...
设 $(A, \leqqq_A)$ 和 $(B, \leqqq_B)$ 是两个偏序集，在 $A \times B$ 上定义关系 $\leqqq$ 为：
$(a_1, b_1) \leqqq (a_2, b_2) \leqqftrightarrow a_1 \leqqq_A a_2 \land b_1 \leqqq_B b_2$
则 $(A \times B, \leqqq)$ 是偏序集。

Let $(A, \leqqq_A)$ and $(B, \leqqq_B)$ be two partially ordered sets, define relation $\leqqq$ on $A \times B$ as:
$(a_1, b_1) \leqqq (a_2, b_2) \leqqftrightarrow a_1 \leqqq_A a_2 \land b_1 \leqqq_B b_2$
Then $(A \times B, \leqqq)$ is a partially ordered set.
...
设 $(A, \leqqq_A)$ 和 $(B, \leqqq_B)$ 是两个偏序集，在 $A \times B$ 上定义字典序 $\leqqq_{lex}$ 为：
$(a_1, b_1) \leqqq_{lex} (a_2, b_2) \leqqftrightarrow a_1 <_A a_2 \lor (a_1 = a_2 \land b_1 \leqqq_B b_2)$
则 $(A \times B, \leqqq_{lex})$ 是偏序集。

Let $(A, \leqqq_A)$ and $(B, \leqqq_B)$ be two partially ordered sets, define lexicographic order $\leqqq_{lex}$ on $A \times B$ as:
$(a_1, b_1) \leqqq_{lex} (a_2, b_2) \leqqftrightarrow a_1 <_A a_2 \lor (a_1 = a_2 \land b_1 \leqqq_B b_2)$
Then $(A \times B, \leqqq_{lex})$ is a partially ordered set.
...
$a \mid b \leqqftrightarrow \exists k \in \mathbb{N}^*(b = a \cdot k)$
则 $(\mathbb{N}^*, \mid)$ 是偏序集。
