...
- [基数与序数理论 - 国际标准版 / Cardinal and Ordinal Theory - International Standard Edition](#基数与序数理论---国际标准版--cardinal-and-ordinal-theory---international-standard-edition)
  ...
  - [六、参考文献 / References](#六参考文献--references)
...
1. 由 $\kappa \leq \lambda$，存在单射 $f : \kappa \to \lambda$
2. 由 $\lambda \leq \kappa$，存在单射 $g : \lambda \to \kappa$
...
1. 首先证明 $\kappa \leq 2^\kappa$：构造单射 $f : \kappa \to 2^\kappa$
2. 然后证明 $\kappa \neq 2^\kappa$：使用对角线法证明不存在满射
3. 结合得到严格不等式

**详细证明**:

- **步骤 1**: 定义 $f : \kappa \to 2^\kappa$ 为 $f(\alpha) = \{\alpha\}$，则 $f$ 是单射，因此 $\kappa \leq 2^\kappa$
...
- 如果 $\beta$ 是极限序数，则 $\aleph_\beta = \sup\{\aleph_\gamma : \gamma < \beta\} \geq \aleph_\alpha$，且由于 $\alpha < \beta$，有 $\aleph_\beta > \aleph_\alpha$
...
- Stanford University: [Math 120A Group Theory][https://mathematics.stanford.edu/][需更新](需更新)
- Harvard University: [Math 122 Algebra I][https://www.math.harvard.edu/][需更新](需更新)
