...
- [1.2 数系与运算 / Number Systems and Operations](#12-数系与运算--number-systems-and-operations)
  - [目录](#目录)
  - [1.2.1 概述 / Overview (编号: B.01.02.01)](#121-概述--overview-编号-b010201)
  - [1.2.2 自然数 / Natural Numbers (编号: B.01.02.02)](#122-自然数--natural-numbers-编号-b010202)
  ...
  - [1.2.3 整数 / Integers (编号: B.01.02.03)](#123-整数--integers-编号-b010203)
  ...
  - [1.2.4 有理数 / Rational Numbers (编号: B.01.02.04)](#124-有理数--rational-numbers-编号-b010204)
  ...
  - [1.2.5 实数 / Real Numbers (编号: B.01.02.05)](#125-实数--real-numbers-编号-b010205)
    - [1.2.5.1 戴德金分割 / Dedekind Cuts](#1251-戴德金分割--dedekind-cuts)
    - [1.2.5.2 实数运算 / Real Number Operations](#1252-实数运算--real-number-operations)
  - [1.2.6 复数 / Complex Numbers (编号: B.01.02.06)](#126-复数--complex-numbers-编号-b010206)
  ...
  - [1.2.7 数系扩展 / Number System Extensions (编号: B.01.02.07)](#127-数系扩展--number-system-extensions-编号-b010207)
  ...
  - [1.2.8 形式化代码示例 / Formal Code Examples (编号: B.01.02.08)](#128-形式化代码示例--formal-code-examples-编号-b010208)
...
## 1.2.1 概述 / Overview (编号: B.01.02.01)

数系是数学的基础，从自然数开始，逐步扩展到整数、有理数、实数和复数。
每个数系都有其独特的代数结构和性质，为数学的各个分支提供了基础。

## 1.2.2 自然数 / Natural Numbers (编号: B.01.02.02)
...
## 1.2.3 整数 / Integers (编号: B.01.02.03)
...
## 1.2.4 有理数 / Rational Numbers (编号: B.01.02.04)
...
## 1.2.5 实数 / Real Numbers (编号: B.01.02.05)
...
## 1.2.6 复数 / Complex Numbers (编号: B.01.02.06)
...
## 1.2.7 数系扩展 / Number System Extensions (编号: B.01.02.07)
...
## 1.2.8 形式化代码示例 / Formal Code Examples (编号: B.01.02.08)
...
- [03-分析学](./../../03-分析学/03-泛函分析/03-泛函分析.md)
