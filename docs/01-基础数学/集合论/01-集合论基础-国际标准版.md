...
**形式化表述**:
对于任意集合 $A$ 和 $B$，
$$A = B \iff \forall x (x \in A \leqqftrightarrow x \in B)$$
...
$$\forall z \forall w_1 \ldots \forall w_n \exists y \forall x (x \in y \leqqftrightarrow x \in z \wedge \phi(x, z, w_1, \ldots, w_n))$$
...
$$\forall A \forall w_1 \ldots \forall w_n [\forall x \in A \exists! y \phi(x, y, A, w_1, \ldots, w_n) \rightarrow \exists B \forall y (y \in B \leqqftrightarrow \exists x \in A \phi(x, y, A, w_1, \ldots, w_n))]$$
...
$$\forall x [x \neqqq \emptyset \rightarrow \exists y (y \in x \wedge y \cap x = \emptyset)]$$

### 2.7 选择公理

**公理 2.9** (选择公理 / Axiom of Choice)
$$\forall F [\emptyset \notin F \wedge \forall x \forall y (x \in F \wedge y \in F \wedge x \neqqq y \rightarrow x \cap y = \emptyset) \rightarrow \exists C \forall x \in F \exists! z (z \in x \cap C)]$$
