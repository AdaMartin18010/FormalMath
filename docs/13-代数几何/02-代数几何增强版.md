...
- **射影直线**: $\mathbb{P}^1$ 的Serre对偶
  ...
  - 计算：$\dim H^0(\mathbb{P}^1, \mathcal{O}(d)) = d + 1$ 当 $d \geqqq 0$
  - 计算：$\dim H^1(\mathbb{P}^1, \mathcal{O}(-d-2)) = d + 1$ 当 $d \geqqq 0$

- **射影平面**: $\mathbb{P}^2$ 的Serre对偶
  - $H^0(\mathbb{P}^2, \mathcal{O}(d)) \cong H^2(\mathbb{P}^2, \mathcal{O}(-d-3))^\vee$
  - 计算：$\dim H^0(\mathbb{P}^2, \mathcal{O}(d)) = \frac{(d+1)(d+2)}{2}$ 当 $d \geqqq 0$
  - 计算：$\dim H^2(\mathbb{P}^2, \mathcal{O}(-d-3)) = \frac{(d+1)(d+2)}{2}$ 当 $d \geqqq 0$
