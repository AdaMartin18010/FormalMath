...
- [代数结构Python实现发布指南](#代数结构python实现发布指南)
  - [概述](#概述)
  - [目录](#目录)
  - [版本管理](#版本管理)
    - [语义化版本](#语义化版本)
  ...
  - [发布流程](#发布流程)
    - [1. 发布前准备](#1-发布前准备)
      ...
      - [1.3 测试验证](#13-测试验证)
    - [2. 版本号确定](#2-版本号确定)
      - [2.1 检查变更类型](#21-检查变更类型)
      - [2.2 确定版本号](#22-确定版本号)
    - [3. 创建发布分支](#3-创建发布分支)
    - [4. 更新版本号](#4-更新版本号)
      - [4.1 更新版本文件](#41-更新版本文件)
      - [4.2 更新setup.py](#42-更新setuppy)
      - [4.3 更新文档](#43-更新文档)
    - [5. 更新变更日志](#5-更新变更日志)
    - [6. 创建Git标签](#6-创建git标签)
    - [7. 构建发布包](#7-构建发布包)
      - [7.1 构建源代码包](#71-构建源代码包)
      - [7.2 验证构建](#72-验证构建)
    - [8. 测试发布包](#8-测试发布包)
    - [9. 发布到PyPI](#9-发布到pypi)
      - [9.1 测试PyPI（可选）](#91-测试pypi可选)
      - [9.2 正式发布](#92-正式发布)
    - [10. 创建GitHub Release](#10-创建github-release)
    - [11. 合并发布分支](#11-合并发布分支)
  - [发布检查清单](#发布检查清单)
    - [代码质量](#代码质量)
    - [文档完整性](#文档完整性)
  ...
  - [回滚流程](#回滚流程)
    - [如果发布出现问题](#如果发布出现问题)
      - [1. 立即回滚PyPI](#1-立即回滚pypi)
      - [2. 发布修复版本](#2-发布修复版本)
      - [3. 更新GitHub Release](#3-更新github-release)
      - [4. 通知用户](#4-通知用户)
  - [自动化发布](#自动化发布)
    - [GitHub Actions工作流](#github-actions工作流)
    - [使用脚本自动化](#使用脚本自动化)
  - [常见问题](#常见问题)
    - [Q1: 如何确定版本号？](#q1-如何确定版本号)
    - [Q2: 发布前需要做什么？](#q2-发布前需要做什么)
    - [Q3: 如何回滚发布？](#q3-如何回滚发布)
    - [Q4: 发布失败怎么办？](#q4-发布失败怎么办)
    - [Q5: 如何处理预发布版本？](#q5-如何处理预发布版本)
  - [发布时间表](#发布时间表)
    - [常规发布周期](#常规发布周期)
    - [发布计划示例](#发布计划示例)
  - [资源链接](#资源链接)
