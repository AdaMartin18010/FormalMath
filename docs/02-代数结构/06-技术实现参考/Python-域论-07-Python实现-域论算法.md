---
title: 'Python实现：域论算法 / Python Implementation: Field Theory Algorithms'
msc_primary: '12
...
references:
  ...
  - id: nlab
    type: database
    name: nLab
    entry_url: https://ncatlab.org/nlab/show/field
...
7. Milne, J. S. (2020). Fields and Galois theory. <https://www.jmilne.org/math/[需更新[需更新]]>
