...
references:
  ...
  - id: nlab
    type: database
    name: nLab
    entry_url: https://ncatlab.org/nlab/show/series
...
- [线性代数与高级数系 - 国际标准版](#线性代数与高级数系---国际标准版)
  ...
  - [🏗️ 1. 线性代数的ZFC构造 / ZFC Construction of Linear Algebra](#1-线性代数的zfc构造-zfc-construction-of-linear-algebra)
...
- [群论-国际标准版](./../../../01-基础数学/抽象代数结构论证/01-群论结构论证-国际标准版.md)
- [环论-国际标准版](./../../../01-基础数学/抽象代数结构论证/02-环论结构论证-国际标准版.md)
- [域论-国际标准版](./../../../01-基础数学/抽象代数结构论证/03-域论结构论证-国际标准版.md)
- [模论-国际标准版](./../../../01-基础数学/抽象代数结构论证/04-模论结构论证-国际标准版.md)
- [李代数-国际标准版](./../../../01-基础数学/抽象代数结构论证/05-李代数结构论证-国际标准版.md)
- [范畴论-国际标准版](./../../../01-基础数学/抽象代数结构论证/06-范畴论结构论证-国际标准版.md)
