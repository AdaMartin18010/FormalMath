...
references:
  ...
  - id: nlab
    type: database
    name: nLab
    entry_url: https://ncatlab.org/nlab/show/Lagrange%27s+theorem
...
**证明**：
由**引理 3.2**，$G$ 可分解为互不相交的左陪集的并：
$$G = a_1 H \cup a_2 H \cup \dots \cup a_k H,$$
其中 $k = [G:H]$。由**引理 3.1**，每个左陪集的大小均为 $|H|$，因此
...
- Michael Artin, *Algebra*, 2nd ed., Pearson, 2011 (Chapters: ['Chapter 2: Groups, Section 2.8']; Pages: 55-60; ISBN: 978-0132413770)
- Gilbert Strang, *Introduction to Linear Algebra*, 5th ed., Wellesley-Cambridge Press, 2016 (ISBN: 978-0980232776)
- David S. Dummit and Richard M. Foote, *Abstract Algebra*, 3rd ed., Wiley, 2003 (Chapters: ['Chapter 3: Quotient Groups and Homomorphisms, Section 3.2']; Pages: 89-95; ISBN: 978-0471433347; MR: MR2286236)

### 数据库与网络资源

- [nLab](https://ncatlab.org/nlab/show/Lagrange%27s+theorem)
