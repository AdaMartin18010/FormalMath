...
- [模论-深度扩展版](#模论-深度扩展版)
  ...
  - [概述](#概述)
  - [🗺️ 模论核心概念思维导图](#模论核心概念思维导图)
  - [📊 模论核心概念多维知识矩阵](#模论核心概念多维知识矩阵)
  - [一、模论深度理论](#一模论深度理论)
  ...
  - [参考文献 / References](#参考文献-references)
    ...
    - [模论教材 / Module Theory Textbooks](#模论教材-module-theory-textbooks)
...
|---------|---------|---------|---------|---------|---------|
| 基础概念 | R-模 | 环作用在阿贝尔群 | 模同态 | Rⁿ, R/I | 代数基础 |
| 基础概念 | 子模 | 模的子集+模结构 | 商模构造 | I ⊆ R | 模分解 |
| 基础概念 | 模同态 | 保持运算 | 核与像 | f: M → N | 模比较 |
| 特殊模类 | 自由模 | 有基的模 | 基唯一性 | Rⁿ | 模构造 |
| 特殊模类 | 投射模 | 提升性质 | 直和项 | 自由模 | 同调代数 |
| 特殊模类 | 内射模 | 延拓性质 | 直和项 | 除环上模 | 同调代数 |
| 特殊模类 | 平坦模 | 张量积正合 | 局部自由 | 自由模 | 同调代数 |
| 模的分解 | 直和分解 | 模的直和 | 不可分解模 | 主不可分解模 | 模分类 |
| 模的分解 | 合成列 | 子模链 | 长度唯一 | 若尔当-赫尔德 | 模分类 |
| 同调代数 | 链复形 | 微分序列 | 同调群 | 奇异同调 | 同调计算 |
| 同调代数 | Ext函子 | 扩张群 | 长正合序列 | Ext¹(M,N) | 同调代数 |
| 同调代数 | Tor函子 | 扭转积 | 长正合序列 | Tor₁(M,N) | 同调代数 |
| 导出范畴 | 导出范畴 | 复形范畴 | 三角范畴 | D(R) | 现代数学 |
| 应用 | 拟凝聚层 | 代数几何中的模 | 层上同调 | 概形上的层 | 代数几何 |
| 应用 | 模表示 | 群的模表示 | 表示论 | 群表示 | 表示论 |
