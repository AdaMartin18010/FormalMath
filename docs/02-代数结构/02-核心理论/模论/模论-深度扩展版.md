...
- [模论-深度扩展版 / Module Theory - Deep Extension Version](#模论-深度扩展版-module-theory---deep-extension-version)
  - 目录 / Table of Contents
  - [1. 高级模论理论 / Advanced Module Theory (编号: B.02.04.01)](#一高级模论理论-advanced-module-theory-编号-b020401)
  ...
  - [2. 同调代数中的模论 / Module Theory in Homological Algebra (编号: B.02.04.02)](#二同调代数中的模论-module-theory-in-homological-algebra-编号-b020402)
  ...
  - [3. 表示论中的模论 / Module Theory in Representation Theory (编号: B.02.04.03)](#三表示论中的模论-module-theory-in-representation-theory-编号-b020403)
  ...
  - [4. 代数几何中的模论 / Module Theory in Algebraic Geometry (编号: B.02.04.04)](#四代数几何中的模论-module-theory-in-algebraic-geometry-编号-b020404)
  ...
  - [5. 模论的哲学思考 / Philosophical Reflections on Module Theory (编号: B.02.04.05)](#五模论的哲学思考-philosophical-reflections-on-module-theory-编号-b020405)
...
## 一、高级模论理论 / Advanced Module Theory (编号: B.02.04.01)
...
## 二、同调代数中的模论 / Module Theory in Homological Algebra (编号: B.02.04.02)
...
## 三、表示论中的模论 / Module Theory in Representation Theory (编号: B.02.04.03)
...
## 四、代数几何中的模论 / Module Theory in Algebraic Geometry (编号: B.02.04.04)
...
## 五、模论的哲学思考 / Philosophical Reflections on Module Theory (编号: B.02.04.05)
