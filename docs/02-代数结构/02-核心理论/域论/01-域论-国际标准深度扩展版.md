...
- [06-代数数论](./../../../04-几何与拓扑/03-拓扑学内容/05-同调论.md)
...
- Milne, J. S. Fields and Galois Theory[EB/OL]. 2020. Available online: <https://www.jmilne.org/math/CourseNotes/FT.pdf[需更新[需更新]]>
...
- Milne, J. S. Algebraic Number Theory[EB/OL]. 2017. Available online: <https://www.jmilne.org/math/CourseNotes/ANT.pdf[需更新[需更新]]>
...
- [交互式图表增强（域扩张/分裂域/伽罗瓦群）](./../../../01-基础数学/集合论/集合论交互式内容增强-2025年1月.md)
- [定理证明补充（塔定理/分裂域存在性）](./../../../01-基础数学/集合论/基数序数理论证明深化-2025年1月.md)
