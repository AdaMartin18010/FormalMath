...
- [域论-深度扩展版](#域论-深度扩展版)
  ...
  - [3. 朗兰兹纲领基础](#三朗兰兹纲领基础)
    - [3.1 朗兰兹对应](#31-朗兰兹对应)
    - [3.2 几何朗兰兹纲领](#32-几何朗兰兹纲领)
    - [3.3 量子朗兰兹纲领](#33-量子朗兰兹纲领)
  - [4. 域论在数学各分支中的应用](#四域论在数学各分支中的应用)
    - [4.1 数论中的应用](#41-数论中的应用)
    - [4.2 几何学中的应用](#42-几何学中的应用)
    - [4.3 分析学中的应用](#43-分析学中的应用)
  - [5. 形式化实现](#五形式化实现)
  ...
  - [6. 历史发展与现代应用](#六历史发展与现代应用)
    ...
    - [6.2 现代应用](#62-现代应用)
  - [7. 前沿研究方向](#七前沿研究方向)
    - [7.1 非阿贝尔类域论](#71-非阿贝尔类域论)
    - [7.2 几何类域论](#72-几何类域论)
    - [7.3 量子类域论](#73-量子类域论)
  - [8. 域论的哲学问题](#八域论的哲学问题)
    - [8.1 代数与几何的统一](#81-代数与几何的统一)
    - [8.2 局部与整体的关系](#82-局部与整体的关系)
    - [8.3 对称性与不变性](#83-对称性与不变性)
  - [9. 域论的计算方面](#九域论的计算方面)
    - [9.1 计算域论](#91-计算域论)
    - [9.2 符号计算](#92-符号计算)
    - [9.3 数值计算](#93-数值计算)
