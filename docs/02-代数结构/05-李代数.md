...
19. **Drinfeld, V. G.** (1985). *Hopf algebras and the quantum Yang-Baxter equation*. Soviet Mathematics Doklady.
20. **Jimbo, M.** (1985). *A q-difference analogue of U(g) and the Yang-Baxter equation*. Letters in Mathematical Physics.
