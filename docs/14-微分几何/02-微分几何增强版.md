...
13. **Atiyah, M. F., & Singer, I. M.** (1963). *The index of elliptic operators on compact manifolds*. Bulletin of the American Mathematical Society.
14. **Perelman, G.** (2003). *The entropy formula for the Ricci flow and its geometric applications*. arXiv.
15. **Thurston, W. P.** (1982). *Three-dimensional manifolds, Kleinian groups and hyperbolic geometry*. Bulletin of the American Mathematical Society.
16. **Donaldson, S. K.** (1983). *An application of gauge theory to four-dimensional topology*. Journal of Differential Geometry.
17. **Witten, E.** (1988). *Topological quantum field theory*. Communications in Mathematical Physics.

### 现代应用文献 / Modern Application Literature

18. **Bronstein, M. M., et al.** (2017). *Geometric deep learning: going beyond Euclidean data*. IEEE Signal Processing Magazine.
19. **Cohen, T. S., & Welling, M.** (2016). *Group equivariant convolutional networks*. International Conference on Machine Learning.
20. **Mallat, S.** (2016). *Understanding deep convolutional networks*. Philosophical Transactions of the Royal Society A.

### 中文高级教材 / Chinese Advanced Textbooks

21. **伍鸿熙** (1989). *黎曼几何初步*. 北京大学出版社.
22. **陈省身** (1983). *微分几何讲义*. 北京大学出版社.
23. **梅向明** (1988). *微分几何*. 高等教育出版社.
