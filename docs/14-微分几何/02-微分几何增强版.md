...
设 $M_1$, $M_2$ 是黎曼流形，$K_1 \geqqq K_2$，则相应的雅可比场满足比较关系。

**Theorem 14.2.4** (Rauch Comparison Theorem)
Let $M_1$, $M_2$ be Riemannian manifolds with $K_1 \geqqq K_2$, then the corresponding Jacobi fields satisfy comparison relations.
