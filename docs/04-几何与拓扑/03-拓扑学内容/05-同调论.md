...
- [同调论](#同调论)
  - 目录 / Table of Contents
  - [概述 (编号: B.05.05.01)](#概述-编号-b050501)
  - [🗺️ 同调论核心概念思维导图](#同调论核心概念思维导图)
  - [📊 同调论核心概念多维知识矩阵](#同调论核心概念多维知识矩阵)
  - [历史背景 (编号: B.05.05.02)](#历史背景-编号-b050502)
    - [同调论的起源](#同调论的起源)
    - [同调论的发展](#同调论的发展)
    - [现代同调论](#现代同调论)
    - [当代应用](#当代应用)
  - [公理化定义 (编号: B.05.05.03)](#公理化定义-编号-b050503)
    - [同调群定义](#同调群定义)
      - [奇异同调群](#奇异同调群)
      - [胞腔同调群](#胞腔同调群)
    - [同调序列](#同调序列)
  ...
  - [基本性质 (编号: B.05.05.04)](#基本性质-编号-b050504)
    - [同调群性质](#同调群性质)
      - [函子性质](#函子性质)
      - [同伦不变性](#同伦不变性)
      - [切除性质](#切除性质)
    ...
    - [对偶性性质](#对偶性性质)
      - [杯积](#杯积)
      - [帽积](#帽积)
  - [形式化证明 (编号: B.05.05.05)](#形式化证明-编号-b050505)
    - [同调群计算](#同调群计算)
    - [同调序列定理](#同调序列定理)
    - [1对偶性定理](#1对偶性定理)
  - [应用实例 (编号: B.05.05.06)](#应用实例-编号-b050506)
    - [代数拓扑应用](#代数拓扑应用)
      - [同伦群计算](#同伦群计算)
      - [流形分类](#流形分类)
    - [几何不变量](#几何不变量)
    ...
    - [分类问题](#分类问题)
      - [同伦等价性](#同伦等价性)
      - [同胚分类](#同胚分类)
  - [与其他主题的关联 (编号: B.05.05.07)](#与其他主题的关联-编号-b050507)
    - [前置知识](#前置知识)
    - [后续发展](#后续发展)
    - [交叉联系](#交叉联系)
...
- [代数几何](./../01-几何学基础/05-代数几何.md) - 代数几何中的同调理论
