---
title: 欧氏与非欧几何为何本质上是射影几何的扩展——形式化论证（Cayley–Klein 视角）
msc_primary: '51

  - 51M10 - 00A99 - 20A99 - 51M09'
...
references:
  ...
  - title: 'Geometry: A Comprehensive Course'
    ...
    isbn: '9780486656128'
external_ids:
  msc_classification_url: https://mathscinet.ams.org/mathscinet/search/mscdoc.html?code=51M10
---
...
- [欧氏与非欧几何为何本质上是射影几何的扩展——形式化论证（Cayley–Klein 视角）](#欧氏与非欧几何为何本质上是射影几何的扩展形式化论证cayleyklein-视角)
  ...
  - [1. 射影预备 / Projective Preliminaries](#一射影预备-projective-preliminaries)
    - [1.1 定义（射影空间与交比）](#11-定义射影空间与交比)
    - [1.2 定义（绝对与保持群）](#12-定义绝对与保持群)
  - [2. Cayley–Klein 距离与测地线 / CK Distance and Geodesics](#二cayleyklein-距离与测地线-ck-distance-and-geodesics)
    - [2.1 定义（CK 距离）](#21-定义ck-距离)
    - [2.2 定理（不变性与完备性，纲要）](#22-定理不变性与完备性纲要)
  - [3. 三大几何的统一刻画 / Unification of Three Geometries](#三三大几何的统一刻画-unification-of-three-geometries)
  ...
  - [4. 角度的射影刻画（对偶绝对） / Angle via Dual Absolute](#四角度的射影刻画对偶绝对-angle-via-dual-absolute)
    - [4.1 定义（对偶绝对与角度）](#41-定义对偶绝对与角度)
    - [4.2 定理（测地与角的相容性，纲要）](#42-定理测地与角的相容性纲要)
  - [5. 形式化小结 / Formal Summary](#五形式化小结-formal-summary)
  - [6. 术语对照表 / Terminology Table](#六术语对照表-terminology-table)
  - [7. 参考文献 / References](#七参考文献-references)
  - [8. 坐标化推导：CK 距离的显式公式（以单位圆/球为绝对）](#八坐标化推导ck-距离的显式公式以单位圆球为绝对)
    - [8.1 平面（单位圆为绝对）](#81-平面单位圆为绝对)
    - [8.2 高维（单位球为绝对）](#82-高维单位球为绝对)
  - [9. 欧氏极限与退化绝对（形式极限）](#九欧氏极限与退化绝对形式极限)
  - [10. 等距群的齐性—各向同性刻画](#十等距群的齐性各向同性刻画)
...
## 一、射影预备 / Projective Preliminaries
...
## 二、Cayley–Klein 距离与测地线 / CK Distance and Geodesics
...
## 三、三大几何的统一刻画 / Unification of Three Geometries
...
## 四、角度的射影刻画（对偶绝对） / Angle via Dual Absolute
