...
**Languages**: [🇨🇳 中文](./ZFC公理体系完整形式化-第二部分：整数构造.md) | **🇬🇧 English**
...
- [ZFC公理体系完整形式化 - 第二部分：整数构造](#zfc公理体系完整形式化---第二部分整数构造)
  ...
  - 🏗️ 整数的构造
    - [1. 整数的Definition](#1-整数的Definition)
      ...
      - [1.2 整数的表示](#12-整数的表示)
    - [2. 整数运算的Definition](#2-整数运算的Definition)
      - [2.1 加法运算](#21-加法运算)
      - [2.2 乘法运算](#22-乘法运算)
    - [3. 整数序关系](#3-整数序关系)
...
本部分将展示如何从ZFC公理体系严格构造整数系统，包括整数的Definition、运算和基本性质的形式化Proof。
这是从Set Theory到Number Theory的重要桥梁。
...
**Definition 1.1** (整数)
整数是自然数序对的等价类，其中等价关系Definition为：
...
**Definition 1.2** (整数的表示)

- 正整数：$n = [(n, 0)]$
- 负整数：$-n = [(0, n)]$
- 零：$0 = [(0, 0)]$

**Theorem 1.2.1** (整数表示的唯一性)
每个整数都有唯一的表示形式。
...
**Theorem 3.2.1** (整数Ring的性质)
整数集合 $\mathbb{Z}$ 在加法和乘法下构成交换Ring。
...
**Theorem 4.2.1** (整数系统的唯一性)
在Isomorphism意义下，整数系统是唯一的。
...
**应用案例 7.1.1** (整数在初等Number Theory中的应用)

- **整除理论**：整数的整除关系是Number Theory的基础
- **素数理论**：整数的唯一因子分解Theorem
- **同余理论**：整数同余关系在Number Theory中的应用

**应用案例 7.1.2** (整数在代数Number Theory中的应用)

- **代数整数**：整数是代数Number Theory的基础
- **数Field**：整数Ring是数Field的基础结构
- **理想理论**：整数Ring的理想理论
...
**应用案例 7.2.1** (整数在Ring Theory中的应用)

- **主理想整Ring**：整数Ring是主理想整Ring的典型Example
- **欧几里得整Ring**：整数Ring是欧几里得整Ring
- **唯一因子分解整Ring**：整数Ring是UFD

**应用案例 7.2.2** (整数在Group Theory中的应用)

- **整数加法Group**：整数在加法下构成Group
- **循RingGroup**：整数Group是无限循RingGroup
- **自由Group**：整数Group是自由阿贝尔Group
...
通过严格的Set Theory构造，我们成功地从ZFC公理体系推导出了整数系统。
