...
**Languages**: [🇨🇳 中文](../zh/ZFC公理体系\Lean4形式化实现-ZFC公理体系.md) | **🇬🇧 English**
...
- [ZFC公理体系 - Lean4形式化实现](#zfc公理体系---lean4形式化实现)
  ...
  - [🔄 3. 强迫法理论形式化](#-3-强迫法理论形式化)
    ...
    - [3.2 泛型滤子](#32-泛型滤子)
    - [3.3 强迫扩展](#33-强迫扩展)
  - [🏗️ 4. 内Module型理论形式化](#️-4-内Module型理论形式化)
    - [4.1 可构造宇宙](#41-可构造宇宙)
    - [4.2 内Module型一致性](#42-内Module型一致性)
  - [🔍 5. 独立性Proof形式化](#-5-独立性Proof形式化)
    - [5.1 选择公理独立性](#51-选择公理独立性)
    - [5.2 Continuous统假设独立性](#52-Continuous统假设独立性)
  - [📊 6. 应用案例形式化](#-6-应用案例形式化)
...
-- Set Theory语言Definition
-- Set theory language definition
/--
## Set Theory语言
## Set theory language

Definition了ZFCSet Theory的形式化语言
