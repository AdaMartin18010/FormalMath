...
msc_secondary:
- 00A99
title: ZFC公理体系完整形式化 - 第四部分：实数构造
processed_at: '2026-04-05'
---
<div class="language-switcher">

**Languages**: [🇨🇳 中文](./ZFC公理体系完整形式化-第四部分：实数构造.md) | **🇬🇧 English**
...
---
msc_primary: "00A05"
msc_secondary: ['03E30', '03E15', '28-XX']
---
...
- [ZFC公理体系完整形式化 - 第四部分：实数构造](#zfc公理体系完整形式化---第四部分实数构造)
  ...
  - 🏗️ 实数的构造
    ...
    - [2. 柯西序列方法](#2-柯西序列方法)
      - [2.1 柯西序列的Definition](#21-柯西序列的Definition)
      - [2.2 柯西序列的等价关系](#22-柯西序列的等价关系)
    - [3. 实数运算的Definition](#3-实数运算的Definition)
      - [3.1 加法运算](#31-加法运算)
      - [3.2 乘法运算](#32-乘法运算)
    - [4. 实数序关系](#4-实数序关系)
      - [4.1 序关系的Definition](#41-序关系的Definition)
    - [5. 实数的完备性](#5-实数的完备性)
      - [5.1 完备性的Definition](#51-完备性的Definition)
      - [5.2 最小上界性质](#52-最小上界性质)
    - [6. 实数的代数性质](#6-实数的代数性质)
      - [6.1 实数Field的性质](#61-实数Field的性质)
      - [6.2 实数的嵌入](#62-实数的嵌入)
    - [7. 实数的拓扑性质](#7-实数的拓扑性质)
      - [7.1 实数的Connected性](#71-实数的Connected性)
      - [7.2 实数的紧性](#72-实数的紧性)
    ...
    - [9. 实数的应用](#9-实数的应用)
      ...
      - [9.3 在Topology中的应用](#93-在Topology中的应用)
...
#### 1.1 戴德金分割的Definition

**Definition 1.1** (戴德金分割)
...
**Definition 1.2** (实数)
实数是戴德金分割的等价类，其中等价关系Definition为：
$$(A, B) \sim (C, D) \leftrightarrow A = C \land B = D$$

**Theorem 1.2.1** (实数Definition的良Definition性)
实数的Definition不依赖于分割的选择。
...
```text
Proof：
(1) 如果 {a_n} Convergent到 L，则对于任意 ε > 0，存在 N 使得 n > N 时 |a_n - L| < ε/2
...
**Definition 3.1** (实数加法 - 戴德金分割)
$$(A, B) + (C, D) = (A + C, B + D)$$

其中 $A + C = \{a + c : a \in A, c \in C\}$。

**Definition 3.1'** (实数加法 - 柯西序列)
$$[\{a_n\}] + [\{b_n\}] = [\{a_n + b_n\}]$$

**Theorem 3.1.1** (加法运算的良Definition性)
加法运算不依赖于代表元的选择。
...
**Definition 5.1** (实数的完备性)
实数集合是完备的，如果每个柯西序列都Convergent到实数。

**Theorem 5.1.1** (实数的完备性)
实数集合在通常的度量下是完备的。
...
**Theorem 6.1.1** (实数Field的性质)
实数集合 $\mathbb{R}$ 在加法和乘法下构成有序Field。
...
```text
Proof：
(1) Definition φ(q) = ({r ∈ Q : r < q}, {r ∈ Q : r ≥ q})
(2) Proof φ 是单射
(3) Proof φ 保持运算
(4) Proof φ 保持序关系
...
**Theorem 7.1.1** (实数的Connected性)
实数集合在通常的拓扑下是Connected的。

**形式化Proof**：

```text
Proof：
(1) 假设 R = A ∪ B，其中 A, B 都是Open Set且不相交
(2) 选择 a ∈ A, b ∈ B
...
**Theorem 8.1.1** (构造方法的等价性)
戴德金分割方法和柯西序列方法构造的实数系统是Isomorphism的。
...
- **序列Convergent**：实数完备性保证了有界单调序列的Convergent性
- **函数Limit**：实数的完备性为函数Limit理论提供基础
- **SeriesConvergent**：实数完备性保证了绝对ConvergentSeries的Convergent性

**应用案例 9.1.2** (实数在Continuous函数理论中的应用)

- **介值Theorem**：利用实数完备性ProofContinuous函数的介值性质
- **最值Theorem**：利用实数完备性和紧性ProofContinuous函数的最值存在性
- **一致Continuous性**：实数完备性在一致Continuous性理论中的应用

**应用案例 9.1.3** (实数在微分理论中的应用)

- **导数存在性**：实数完备性为导数Definition提供基础
- **中值Theorem**：利用实数完备性Proof微分中值Theorem
- **泰勒展开**：实数完备性保证泰勒Series的Convergent性

**应用案例 9.1.4** (实数在积分理论中的应用)

- **黎曼积分**：实数完备性为黎曼积分的存在性提供保证
- **勒贝格积分**：实数完备性在测度论和勒贝格积分中的应用
- **积分中值Theorem**：利用实数完备性Proof积分中值Theorem

#### 9.2 在几何中的应用

**Theorem 9.2.1** (实数在几何中的应用)
实数为几何学提供了数轴Module型。
...
- **拓扑空间**：实数集构成重要的拓扑空间
- **Connected性**：实数集的Connected性分析
- **紧性**：实数集子集的紧性判定（海涅-博雷尔Theorem）
...
通过严格的Set Theory构造，我们成功地从有理数系统推导出了实数系统。
