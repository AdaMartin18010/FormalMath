...
- [符号计算](#符号计算)
  - 目录 / Table of Contents
  - [概述 (编号: B.08.06.01)](#概述-编号-b080601)
  - [历史背景](#历史背景)
    - [早期符号计算](#早期符号计算)
    - [符号计算理论的发展](#符号计算理论的发展)
    - [现代符号计算系统](#现代符号计算系统)
    - [当代发展](#当代发展)
  - [公理化定义 (编号: B.08.06.03)](#公理化定义-编号-b080603)
    - [符号计算基础](#符号计算基础)
      - [符号表达式](#符号表达式)
      - [计算机代数系统](#计算机代数系统)
    - [符号算法理论](#符号算法理论)
    ...
    - [符号积分算法](#符号积分算法)
      - [Risch算法](#risch算法)
      - [部分分式分解](#部分分式分解)
  - [基本算法 (编号: B.08.06.04)](#基本算法-编号-b080604)
    - [多项式计算](#多项式计算)
      - [多项式乘法](#多项式乘法)
      - [多项式因式分解](#多项式因式分解)
    - [符号积分](#符号积分)
  ...
  - [应用实例](#应用实例)
    - [数学软件实现](#数学软件实现)
      - [Maple符号计算系统](#maple符号计算系统)
      - [Mathematica符号计算系统](#mathematica符号计算系统)
    - [科学计算](#科学计算)
      - [物理问题求解](#物理问题求解)
      - [化学计算](#化学计算)
    - [数学教育](#数学教育)
...
- [代数结构](../02-代数结构/00-README.md) - 代数理论基础

### 后续发展

- [并行计算](./04-并行计算.md) - 并行符号计算
- [人工智能数学](../11-高级数学/33-人工智能数学-深化版.md) - 符号计算与AI结合
- [计算机代数](../08-计算数学/05-符号计算.md) - 高级计算机代数
...
- [MathWorld: Symbolic Computation](https://mathworld.wolfram.com/)
- [SageMath Documentation](https://doc.sagemath.org/)[需更新][需更新]
