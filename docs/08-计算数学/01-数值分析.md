...
msc_primary: '65
  ...
  - 65A99 - 00A99 - 00A99 - 00A99 - 00A99 - 65G50'
...
external_ids:
  ...
  stacks_search_url: https://stacks.math.columbia.edu/search?query=%E6%95%B0%E5%80%BC%E5%88%86%E6%9E%90
  nlab_url: https://ncatlab.org/nlab/show/numerical+analysis
  msc_classification_url: https://mathscinet.ams.org/mathscinet/search/mscdoc.html?code=65A99
---
...
## 二、插值与逼近 / Interpolation and Approximation
...
牛顿插值多项式定义为：
$$N_n(x) = f[x_0] + fx_0, x_1 + \cdots + fx_0, \ldots, x_n \cdots (x - x_{n-1})$$
...
## 四、数值微分 / Numerical Differentiation
...
## 七、微分方程数值解 / Numerical Solution of Differential Equations
