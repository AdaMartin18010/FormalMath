...
- [计算几何 / Computational Geometry](#计算几何-computational-geometry)
  - 目录 / Table of Contents
  - [概述 (编号: B.08.03.01)](#概述-编号-b080301)
  - [历史背景 (编号: B.08.03.02)](#历史背景-编号-b080302)
  - [公理化定义 (编号: B.08.03.03)](#公理化定义-编号-b080303)
    - [基本几何对象](#基本几何对象)
    - [几何关系](#几何关系)
  - [基本性质 (编号: B.08.03.04)](#基本性质-编号-b080304)
    - [凸包性质](#凸包性质)
    - [三角剖分性质](#三角剖分性质)
  - [形式化证明 (编号: B.08.03.05)](#形式化证明-编号-b080305)
    - [Graham扫描算法正确性](#graham扫描算法正确性)
    - [时间复杂度分析](#时间复杂度分析)
  - [应用实例 (编号: B.08.03.06)](#应用实例-编号-b080306)
    - [实例1：最近点对问题](#实例1最近点对问题)
    - [实例2：线段相交检测](#实例2线段相交检测)
    - [实例3：Voronoi图构造](#实例3voronoi图构造)
  - [与其他主题的关联](#与其他主题的关联)
    - [前置知识](#前置知识)
    - [后续发展](#后续发展)
    - [交叉联系](#交叉联系)
