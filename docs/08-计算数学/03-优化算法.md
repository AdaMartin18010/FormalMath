...
- [优化算法](#优化算法)
  - 目录 / Table of Contents
  - [概述 (编号: B.08.04.01)](#概述-编号-b080401)
  - [历史背景](#历史背景)
    - [线性规划的诞生](#线性规划的诞生)
    - [非线性优化的发展](#非线性优化的发展)
    - [全局优化算法的兴起](#全局优化算法的兴起)
    - [现代优化理论的形成](#现代优化理论的形成)
  - [公理化定义 (编号: B.08.04.03)](#公理化定义-编号-b080403)
    - [优化问题形式化定义](#优化问题形式化定义)
    - [最优性条件](#最优性条件)
      - [一阶必要条件 (KKT条件)](#一阶必要条件-kkt条件)
      - [二阶充分条件](#二阶充分条件)
  - [基本算法 (编号: B.08.04.04)](#基本算法-编号-b080404)
    - [线性规划算法](#线性规划算法)
      - [单纯形法](#单纯形法)
      - [内点法](#内点法)
    - [非线性优化方法](#非线性优化方法)
    ...
    - [随机优化算法](#随机优化算法)
      - [随机梯度下降](#随机梯度下降)
      - [随机搜索](#随机搜索)
  - [形式化证明 (编号: B.08.04.05)](#形式化证明-编号-b080405)
    - [收敛性分析](#收敛性分析)
    - [复杂度分析](#复杂度分析)
    - [1最优性条件](#1最优性条件)
  - [应用实例 (编号: B.08.04.06)](#应用实例-编号-b080406)
    - [机器学习优化](#机器学习优化)
      - [支持向量机优化](#支持向量机优化)
      - [神经网络训练](#神经网络训练)
    - [金融投资组合](#金融投资组合)
      - [马科维茨投资组合优化](#马科维茨投资组合优化)
      - [风险平价模型](#风险平价模型)
    - [工程设计优化](#工程设计优化)
      - [结构优化](#结构优化)
      - [参数优化](#参数优化)
...
- [线性代数](./00-README.md) - 矩阵运算和线性系统求解
- [微积分](./00-README.md) - 导数和积分的概念

### 后续发展

- [并行计算](./04-并行计算.md) - 并行优化算法
- [符号计算](./05-符号计算.md) - 符号优化方法
- [机器学习数学](../11-高级数学/25-机器学习数学.md) - 机器学习中的优化
...
- [MathWorld: Optimization](https://mathworld.wolfram.com/)
- [Stanford CS229: Machine Learning](http://cs229.stanford.edu/)[需更新][需更新]
