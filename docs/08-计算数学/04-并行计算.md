...
references:
  ...
  - title: 'Concrete Mathematics: A Foundation for Computer Science'
    ...
    isbn: '9780131558362'
external_ids:
  msc_classification_url: https://mathscinet.ams.org/mathscinet/search/mscdoc.html?code=68W10
---
# 并行计算
...
- [并行计算](#并行计算)
  - 目录 / Table of Contents
  - [概述 (编号: B.08.05.01)](#概述-编号-b080501)
  - [历史背景](#历史背景)
    - [早期并行计算](#早期并行计算)
    - [并行计算理论的发展](#并行计算理论的发展)
    - [大规模并行计算](#大规模并行计算)
    - [现代并行计算](#现代并行计算)
  - [公理化定义 (编号: B.08.05.03)](#公理化定义-编号-b080503)
    - [并行计算模型](#并行计算模型)
      - [PRAM模型 (Parallel Random Access Machine)](#pram模型-parallel-random-access-machine)
      - [网络模型](#网络模型)
    - [并行复杂度理论](#并行复杂度理论)
      - [并行时间复杂性](#并行时间复杂性)
      - [并行空间复杂性](#并行空间复杂性)
    ...
    - [分布式计算模型](#分布式计算模型)
      - [消息传递模型](#消息传递模型)
      - [共享内存模型](#共享内存模型)
  - [基本算法 (编号: B.08.05.04)](#基本算法-编号-b080504)
    - [并行排序算法](#并行排序算法)
      - [并行归并排序](#并行归并排序)
      - [并行快速排序](#并行快速排序)
    - [并行图算法](#并行图算法)
      - [并行广度优先搜索 (BFS)](#并行广度优先搜索-bfs)
      - [并行最短路径算法](#并行最短路径算法)
    - [并行数值算法](#并行数值算法)
      - [并行矩阵乘法](#并行矩阵乘法)
      - [并行线性系统求解](#并行线性系统求解)
  - [形式化证明 (编号: B.08.05.05)](#形式化证明-编号-b080505)
    - [并行算法正确性](#并行算法正确性)
    - [并行复杂度分析](#并行复杂度分析)
    - [加速比分析](#加速比分析)
  - [应用实例 (编号: B.08.05.06)](#应用实例-编号-b080506)
    - [大规模数值计算](#大规模数值计算)
      - [并行有限元分析](#并行有限元分析)
      - [并行分子动力学](#并行分子动力学)
    - [科学计算](#科学计算)
...
- [算法理论](../08-计算数学/03-优化算法.md) - 算法设计和分析

### 后续发展

- [符号计算](./05-符号计算.md) - 并行符号计算
- [量子计算](../11-高级数学/40-量子计算数学基础.md) - 量子并行计算
- [分布式系统](../10-应用数学/09-网络科学数学-深化版.md) - 分布式并行计算
...
- [MathWorld: Parallel Algorithm](https://mathworld.wolfram.com/)
- [NVIDIA: CUDA Programming Guide](https://docs.nvidia.com/cuda/)[需更新][需更新]
