...
|------|---------|---------|---------|---------|---------------|
| 欧几里得几何 | 点 | 无大小位置 | 基本对象 | 几何构造 | 基础数学 |
| 欧几里得几何 | 直线 | 无限延伸一维 | 最短路径 | 几何证明 | 基础数学 |
| 欧几里得几何 | 平面 | 无限延伸二维 | 唯一性 | 空间几何 | 基础数学 |
| 解析几何 | 坐标系统 | 数对对应点 | 一一对应 | 函数图像 | 分析学 |
| 解析几何 | 曲线 | 参数方程 | 连续性 | 轨迹研究 | 分析学 |
| 解析几何 | 曲面 | 隐式方程 | 光滑性 | 空间研究 | 分析学 |
| 微分几何 | 流形 | 局部欧几里得 | 可微结构 | 广义相对论 | 拓扑学、分析学 |
| 微分几何 | 切空间 | 切向量空间 | 线性结构 | 向量场 | 线性代数 |
| 微分几何 | 曲率 | 偏离平坦度 | 内蕴性质 | 几何不变量 | 拓扑学 |
| 微分几何 | 联络 | 平行移动 | 协变导数 | 规范理论 | 物理学 |
| 代数几何 | 代数簇 | 多项式零点 | 代数结构 | 数论几何 | 代数结构、数论 |
| 代数几何 | 层 | 局部数据 | 上同调 | 不变量计算 | 同调代数 |
| 代数几何 | 概形 | 环的谱 | 局部化 | 现代代数几何 | 代数结构 |
| 拓扑几何 | 拓扑空间 | 开集族 | 连续映射 | 拓扑性质 | 拓扑学 |
| 拓扑几何 | 同胚 | 连续双射 | 拓扑等价 | 分类问题 | 拓扑学 |
