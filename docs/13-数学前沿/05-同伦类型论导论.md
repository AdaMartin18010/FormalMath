...
external_ids:
  ...
  msc_classification_url: https://mathscinet.ams.org/mathscinet/search/mscdoc.html?code=03B38
references:
  databases:
  - id: wikidata
    type: database
...
| Lean 4 HoTT | https://github.com/leanprover-community | HoTT库 |
