...
## 一、描述性统计 / Descriptive Statistics (编号: B.12.02.01)
...
## 二、推断统计 / Inferential Statistics (编号: B.12.02.02)
...
## 三、假设检验 / Hypothesis Testing (编号: B.12.02.03)
...
## 四、置信区间 / Confidence Intervals (编号: B.12.02.04)
...
## 五、回归分析 / Regression Analysis (编号: B.12.02.05)
...
## 六、方差分析 / Analysis of Variance (编号: B.12.02.06)
...
## 七、非参数统计 / Nonparametric Statistics (编号: B.12.02.07)
...
## 八、贝叶斯统计 / Bayesian Statistics (编号: B.12.02.08)
...
## 九、形式化实现 / Formal Implementation (编号: B.12.02.09)
