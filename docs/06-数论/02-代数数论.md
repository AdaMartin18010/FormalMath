...
3. $|\Delta_K| \geqq 3$ 除非 $K = \mathbb{Q}$
...
理想 $P$ 称为素理想，如果 $P \neqq \mathcal{O}_K$ 且对于任意 $a, b \in \mathcal{O}_K$，$ab \in P$ 蕴含 $a \in P$ 或 $b \in P$。

**定义 6.2.3.4** (极大理想 / Maximal Ideal)
理想 $M$ 称为极大理想，如果 $M \neqq \mathcal{O}_K$ 且不存在理想 $I$ 使得 $M \subset I \subset \mathcal{O}_K$。
