...
- [6.2 代数数论 / Algebraic Number Theory](#62-代数数论--algebraic-number-theory)
  ...
  - [6.2.3 理想理论 / Ideal Theory](#623-理想理论--ideal-theory)
    ...
    - [6.2.3.2 素理想 / Prime Ideals](#6232-素理想--prime-ideals)
  ...
  - [6.2.4 类群与单位群 / Class Group and Unit Group](#624-类群与单位群--class-group-and-unit-group)
    ...
    - [6.2.4.3 狄利克雷单位定理 / Dirichlet's Unit Theorem](#6243-狄利克雷单位定理--dirichlets-unit-theorem)
  - [6.2.5 局部域 / Local Fields](#625-局部域--local-fields)
    - [6.2.5.1 局部化 / Localization](#6251-局部化--localization)
    - [6.2.5.2 完备化 / Completion](#6252-完备化--completion)
    - [6.2.5.3 局部域的结构 / Structure of Local Fields](#6253-局部域的结构--structure-of-local-fields)
  - [6.2.6 类域论 / Class Field Theory](#626-类域论--class-field-theory)
    - [6.2.6.1 阿贝尔扩张 / Abelian Extensions](#6261-阿贝尔扩张--abelian-extensions)
    - [6.2.6.2 阿廷互反律 / Artin Reciprocity](#6262-阿廷互反律--artin-reciprocity)
    - [6.2.6.3 类域 / Class Fields](#6263-类域--class-fields)
  - [6.2.7 L函数 / L-Functions](#627-l函数--l-functions)
    ...
    - [6.2.7.3 函数方程 / Functional Equations](#6273-函数方程--functional-equations)
