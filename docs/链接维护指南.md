...
**错误示例：**
```markdown
[相关文档](./../ref/Books/AbstractAlgebra/Alcock L. How to Think About Abstract Algebra 2021/full.md)  // 路径层级错误
```

**正确写法：**
```markdown
[相关文档](./../ref/Books/AbstractAlgebra/Alcock L. How to Think About Abstract Algebra 2021/full.md)  // 根据实际位置调整
```
...
**正确写法：**
```markdown
[查看详情](./../FormalMath-Interactive/node_modules/aggregate-error/readme.md)
```
