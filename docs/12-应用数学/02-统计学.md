...
- [统计学 / Statistics](#统计学--statistics)
  ...
  - [1. 描述性统计 / Descriptive Statistics (编号: B.12.02.01)](#1-描述性统计--descriptive-statistics-编号-b120201)
  ...
  - [2. 推断统计 / Inferential Statistics (编号: B.12.02.02)](#2-推断统计--inferential-statistics-编号-b120202)
  ...
  - [3. 假设检验 / Hypothesis Testing (编号: B.12.02.03)](#3-假设检验--hypothesis-testing-编号-b120203)
  ...
  - [4. 置信区间 / Confidence Intervals (编号: B.12.02.04)](#4-置信区间--confidence-intervals-编号-b120204)
  ...
  - [5. 回归分析 / Regression Analysis (编号: B.12.02.05)](#5-回归分析--regression-analysis-编号-b120205)
  ...
  - [6. 方差分析 / Analysis of Variance (编号: B.12.02.06)](#6-方差分析--analysis-of-variance-编号-b120206)
    - [6.1 单因素方差分析 / One-Way ANOVA](#61-单因素方差分析--one-way-anova)
    - [6.2 双因素方差分析 / Two-Way ANOVA](#62-双因素方差分析--two-way-anova)
  - [7. 非参数统计 / Nonparametric Statistics (编号: B.12.02.07)](#7-非参数统计--nonparametric-statistics-编号-b120207)
  ...
  - [8. 贝叶斯统计 / Bayesian Statistics (编号: B.12.02.08)](#8-贝叶斯统计--bayesian-statistics-编号-b120208)
  ...
  - [9. 形式化实现 / Formal Implementation (编号: B.12.02.09)](#9-形式化实现--formal-implementation-编号-b120209)
...
## 1. 描述性统计 / Descriptive Statistics (编号: B.12.02.01)
...
偏度定义为：
$$\text{Skewness} = \frac{1}{n}\sum_{i=1}^{n} \leqqft(\frac{x_i - \bar{x}}{s}\right)^3$$

**定义 1.4.2** (峰度 / Kurtosis)
峰度定义为：
$$\text{Kurtosis} = \frac{1}{n}\sum_{i=1}^{n} \leqqft(\frac{x_i - \bar{x}}{s}\right)^4 - 3$$

## 2. 推断统计 / Inferential Statistics (编号: B.12.02.02)
...
$$\bar{X} \sim \text{Normal}\leqqft(\mu, \frac{\sigma^2}{n}\right)$$
...
## 3. 假设检验 / Hypothesis Testing (编号: B.12.02.03)
...
- 如果 $|t| \leqqq t_{\alpha/2, n-1}$，接受 $H_0$
...
**检验统计量**:
$$t = \frac{\bar{x}_1 - \bar{x}_2}{\sqrt{s_p^2\leqqft(\frac{1}{n_1} + \frac{1}{n_2}\right)}}$$
...
## 4. 置信区间 / Confidence Intervals (编号: B.12.02.04)
...
**置信区间**:
$$\leqqft[\frac{(n-1)s^2}{\chi^2_{\alpha/2, n-1}}, \frac{(n-1)s^2}{\chi^2_{1-\alpha/2, n-1}}\right]$$

## 5. 回归分析 / Regression Analysis (编号: B.12.02.05)
...
## 6. 方差分析 / Analysis of Variance (编号: B.12.02.06)
...
## 7. 非参数统计 / Nonparametric Statistics (编号: B.12.02.07)
...
- 如果 $S \geqqq s_{\alpha/2}$ 或 $S \leqqq n - s_{\alpha/2}$，拒绝 $H_0$
...
## 8. 贝叶斯统计 / Bayesian Statistics (编号: B.12.02.08)
...
## 9. 形式化实现 / Formal Implementation (编号: B.12.02.09)
