...
\text{subject to} \quad & Ax \leqqq b \\
& x \geqqq 0
\end{aligned}
$$
...
\text{subject to} \quad & 2x_1 + x_2 \leqqq 8 \\
& x_1 + 2x_2 \leqqq 6 \\
& x_1, x_2 \geqqq 0
\end{aligned}
$$
...
\text{subject to} \quad & g_i(x) \leqqq 0, \quad i = 1, \ldots, m \\
& h_j(x) = 0, \quad j = 1, \ldots, p
\end{aligned}
$$

**定理 2.3** (KKT条件)
设 $x^*$ 为约束优化问题的局部最小值点，且约束满足正则性条件，则存在拉格朗日乘子 $\lambda_i \geqqq 0$ 和 $\mu_j$，使得：
