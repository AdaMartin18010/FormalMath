...
- [3. 泛函分析 / Functional Analysis](#3-泛函分析-functional-analysis)
  - [📋 目录](#目录)
  - [3.1 概述 / Overview (编号: B.03.03.01)](#31-概述-overview-编号-b030301)
  - [🗺️ 泛函分析核心概念思维导图](#泛函分析核心概念思维导图)
  - [📊 泛函分析核心概念多维知识矩阵](#泛函分析核心概念多维知识矩阵)
  - [3.2 赋范空间 / Normed Spaces (编号: B.03.03.02)](#32-赋范空间-normed-spaces-编号-b030302)
  ...
  - [3.3 巴拿赫空间 / Banach Spaces (编号: B.03.03.03)](#33-巴拿赫空间-banach-spaces-编号-b030303)
  ...
  - [3.4 希尔伯特空间 / Hilbert Spaces (编号: B.03.03.04)](#34-希尔伯特空间-hilbert-spaces-编号-b030304)
  ...
  - [3.5 线性算子 / Linear Operators (编号: B.03.03.05)](#35-线性算子-linear-operators-编号-b030305)
  ...
  - [3.6 谱理论 / Spectral Theory (编号: B.03.03.06)](#36-谱理论-spectral-theory-编号-b030306)
  ...
  - [3.7 弱拓扑 / Weak Topology (编号: B.03.03.07)](#37-弱拓扑-weak-topology-编号-b030307)
    - [3.7.1 弱收敛 / Weak Convergence](#371-弱收敛-weak-convergence)
    - [3.7.2 弱紧性 / Weak Compactness](#372-弱紧性-weak-compactness)
  - [3.8 形式化实现 / Formal Implementation (编号: B.03.03.08)](#38-形式化实现-formal-implementation-编号-b030308)
  ...
  - [3.9 应用实例 / Applications (编号: B.03.03.09)](#39-应用实例-applications-编号-b030309)
...
- MIT OpenCourseWare: [18.102 Introduction to Functional Analysis](https://ocw.mit.edu/)
...
- [交互式图表增强（谱分解/算子可视化）](./../../01-基础数学/集合论/集合论交互式内容增强-2025年1月.md)
- [定理证明补充（巴拿赫不动点/谱半径性质）](./../../01-基础数学/集合论/基数序数理论证明深化-2025年1月.md)
