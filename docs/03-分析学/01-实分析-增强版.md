...
1. [概述](#概述)
   1.1. [核心特征](#核心特征)
2. [历史发展脉络](#历史发展脉络)
   2.1. [古代数学时期 (公元前300年 - 17世纪)](#古代数学时期-公元前300年---17世纪)
      2.1.1. [重要人物贡献](#重要人物贡献)
   2.2. [现代发展 (20世纪至今)](#现代发展-20世纪至今)
      2.2.1. [主要成就](#主要成就)
3. [基础概念](#基础概念)
   3.1. [集合论基础](#集合论基础)
      3.1.1. [实数集的性质](#实数集的性质)
...
10. [应用场景](#应用场景)
    ...
    10.2. [社会科学应用](#社会科学应用)
       ...
       10.2.2. [统计学](#统计学)
11. [形式化实现](#形式化实现-2)
    11.1. [Lean 4 实现](#lean-4-实现)
    11.2. [Haskell 实现](#haskell-实现)
    11.3. [Rust 实现](#rust-实现)
12. [思维过程表征](#思维过程表征)
    12.1. [问题解决流程](#问题解决流程)
       12.1.1. [极限计算思维过程](#极限计算思维过程)
       12.1.2. [连续性判断思维过程](#连续性判断思维过程)
       12.1.3. [可微性判断思维过程](#可微性判断思维过程)
    12.2. [证明思维过程](#证明思维过程)
       12.2.1. [中值定理证明](#中值定理证明)
       12.2.2. [积分中值定理证明](#积分中值定理证明)
13. [实例表征](#实例表征)
    13.1. [经典实例](#经典实例)
       13.1.1. [1. 狄利克雷函数](#1-狄利克雷函数)
       13.1.2. [2. 魏尔斯特拉斯函数](#2-魏尔斯特拉斯函数)
       13.1.3. [3. 康托尔集](#3-康托尔集)
    13.2. [应用实例](#应用实例)
       13.2.1. [1. 物理学应用](#1-物理学应用)
       13.2.2. [2. 经济学应用](#2-经济学应用)
       13.2.3. [3. 工程应用](#3-工程应用)
14. [总结与展望](#总结与展望)
    14.1. [主要成就](#主要成就-1)
    14.2. [现代发展](#现代发展)
    14.3. [未来方向](#未来方向)
