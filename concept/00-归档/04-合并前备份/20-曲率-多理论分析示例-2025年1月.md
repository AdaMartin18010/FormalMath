---
title: '曲率概念的多理论分析示例 / Multi-Theory Analysis Example: Curvature Concept'
msc_primary: 00A99
...
**关联概念 / Related Concepts**: 曲率 / Curvature | 曲率-三视角版 / Curvature-Three Perspectives
...
- 曲率概念的多理论分析示例 / Multi-Theory Analysis Example: Curvature Concept
  - 📋 概述 / Overview
  - 📑 目录 / Table of Contents
  - 🎯 一、Tall三个世界理论分析 / Tall's Three Worlds Theory Analysis (编号: C.CORE.020.MULTI.01)
  ...
  - 🔬 二、Dubinsky APOS理论分析 (编号: C.CORE.020.MULTI.02)
  ...
  - 💬 三、Sfard交流理论分析 / Sfard's Commognitive Theory Analysis (编号: C.CORE.020.MULTI.03)
...
- 曲率 / Curvature
- 曲率-三视角版 / Curvature-Three Perspectives Version
