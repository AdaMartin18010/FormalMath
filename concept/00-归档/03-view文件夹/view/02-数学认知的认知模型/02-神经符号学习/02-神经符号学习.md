...
- [**神经符号学习**](#神经符号学习)
  ...
  - [**一、引言**](#一引言)
    ...
    - [**1.4 文档结构**](#14-文档结构)
  - [**二、核心思想**](#二核心思想)
    - [**2.1 神经符号学习思维导图**](#21-神经符号学习思维导图)
    - [**2.2 神经符号整合**](#22-神经符号整合)
      - [**2.2.1 权威定义**](#221-权威定义)
      - [**2.2.2 整合目标**](#222-整合目标)
      - [**2.2.3 整合优势**](#223-整合优势)
    - [**2.3 关键问题**](#23-关键问题)
  - [**三、研究内容**](#三研究内容)
    - [**3.1 符号-神经对应**](#31-符号-神经对应)
      - [**3.1.1 数学符号的神经网络表示**](#311-数学符号的神经网络表示)
      - [**3.1.2 符号操作的神经网络实现**](#312-符号操作的神经网络实现)
      - [**3.1.3 抽象概念的分布式表征**](#313-抽象概念的分布式表征)
      - [**3.1.4 符号-神经对应对比矩阵**](#314-符号-神经对应对比矩阵)
    - [**2. 推理机制**](#2-推理机制)
  ...
  - [**七、总结与展望**](#七总结与展望)
    - [**7.1 主要观点总结**](#71-主要观点总结)
    - [**7.2 理论贡献**](#72-理论贡献)
    - [**7.3 未来研究方向**](#73-未来研究方向)
    - [**7.4 与三层结构的关系总结**](#74-与三层结构的关系总结)
  - [**八、参考文献**](#八参考文献)
    - [**8.1 神经符号学习核心文献**](#81-神经符号学习核心文献)
    - [**8.2 理论基础文献**](#82-理论基础文献)
    - [**8.3 数学推理的神经符号模型**](#83-数学推理的神经符号模型)
    - [**8.4 抽象概念的神经符号表示**](#84-抽象概念的神经符号表示)
    - [**8.5 权威资源参考**](#85-权威资源参考)
    - [**8.6 相关文档**](#86-相关文档)
...
- Rocktäschel, T., & Riedel, S. (2017). End-to-end differentiable proving. *Advances in Neural Information Processing Systems*, 30, 3788-3800. [链接][https://proceedings.neurips.cc/paper/2017/hash/8fb21ee7a2207526da55a679f0332de2-Abstract.html](需更新)[需更新]
...
1. **Hinton, G. E. (1990). Connectionist symbol processing**
   - 连接主义符号处理
   - 符号的分布式表示
   - 符号操作的连接主义实现

2. **Smolensky, P. (1988). On the proper treatment of connectionism**
   - 连接主义的正确处理
   - 符号与连接的整合
   - 认知的符号-连接主义模型

3. **Sun, R. (1994). *Integrating Rules and Connectionism for Robust Commonsense Reasoning***
   - 规则与连接主义的整合
   - 常识推理的神经符号模型
   - 混合认知架构
...
1. **Rocktäschel, T., & Riedel, S. (2017). End-to-end differentiable proving**
   - 端到端可微证明
   - 神经符号推理系统
   - 数学证明的神经网络方法

2. **Evans, R., & Grefenstette, E. (2018). Learning explanatory rules from noisy data**
   - 从噪声数据学习解释性规则
   - 神经符号学习系统
   - 可解释的机器学习

3. **Dong, H., et al. (2019). Neural logic machines**
   - 神经逻辑机器
   - 逻辑推理的神经网络实现
   - 符号操作的神经网络学习
...
3. **Dehaene, S., et al. (1998). Abstract representations of numbers in the animal and human brain**
    - 动物和人类大脑中数字的抽象表示
    - 数字的神经符号表征
    - 数量感的神经基础
...
1. Hinton, G. E. (1990). Connectionist symbol processing. *Artificial Intelligence*, 46(1-2), 1-40. [DOI](https://doi.org/10.1016/0004-3702(90)90002-5)

2. Smolensky, P. (1988). On the proper treatment of connectionism. *Behavioral and Brain Sciences*, 11(1), 1-23. [DOI](https://doi.org/10.1017/S0140525X00052432)

3. Sun, R. (1994). *Integrating Rules and Connectionism for Robust Commonsense Reasoning*. John Wiley & Sons.

### **8.3 数学推理的神经符号模型**

1. Rocktäschel, T., & Riedel, S. (2017). End-to-end differentiable proving. *Advances in Neural Information Processing Systems*, 30, 3788-3800. [链接][https://proceedings.neurips.cc/paper/2017/hash/8fb21ee7a2207526da55a679f0332de2-Abstract.html](需更新)[需更新]

2. Evans, R., & Grefenstette, E. (2018). Learning explanatory rules from noisy data. *Journal of Artificial Intelligence Research*, 61, 1-64. [DOI](https://doi.org/10.1613/jair.5714)

3. Dong, H., et al. (2019). Neural logic machines. *arXiv preprint arXiv:1904.11694*. [链接](https://arxiv.org/abs/1904.11694)
...
2. Lake, B. M., Salakhutdinov, R., & Tenenbaum, J. B. (2015). Human-level concept learning through probabilistic program induction. *Science*, 350(6266), 1332-1338. [DOI](https://doi.org/10.1126/science.aab3050)

3. Dehaene, S., et al. (1998). Abstract representations of numbers in the animal and human brain. *Trends in Neurosciences*, 21(8), 355-361. [DOI](https://doi.org/10.1016/S0166-2236(98)01263-6)

### **8.5 权威资源参考**

1. Wikipedia contributors. (2024). *Neural-symbolic computing*. Wikipedia. [链接](https://en.wikipedia.org/wiki/Neural-symbolic_computing)

2. Wikipedia contributors. (2024). *Connectionism*. Wikipedia. [链接](https://en.wikipedia.org/wiki/Connectionism)

3. Wikipedia contributors. (2024). *Symbolic artificial intelligence*. Wikipedia. [链接](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)

4. Wikipedia contributors. (2024). *Distributed representation*. Wikipedia. [链接](https://en.wikipedia.org/wiki/Distributed_representation)
