...
- [表示](../核心概念/32-表示.md) (C.CORE.032) - 表示论核心概念的三视角深度分析
- [朗兰兹纲领](../核心概念/33-朗兰兹纲领.md) (C.CORE.033) - 数论-几何-表示论交叉领域的核心概念三视角深度分析
...
1. **导出代数几何** → **∞-范畴** → **稳定范畴**
2. **算术几何** → **L函数** → **朗兰兹纲领**
3. **拓扑几何** → **K理论** → **Atiyah-Singer指标定理**
4. **微分几何** → **几何偏微分方程** → **Yamabe问题**
