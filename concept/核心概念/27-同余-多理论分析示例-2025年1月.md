...
- **形式化定义 / Formal Definition**：
  - 同余的形式化定义：$\text{Prime}(p) \leqqftrightarrow p > 1 \land \forall a, b \in \mathbb{Z}^+, p = ab \Rightarrow (a = 1 \lor b = 1)$ / Formal definition of congruences: $\text{Prime}(p) \leqqftrightarrow p > 1 \land \forall a, b \in \mathbb{Z}^+, p = ab \Rightarrow (a = 1 \lor b = 1)$
