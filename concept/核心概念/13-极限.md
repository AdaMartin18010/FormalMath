...
- **例子1**: $\lim_{x \to 0} \frac{\sin x}{x} = 1$
  ...
  - **数值验证**:
    - $x = 0.1$: $\frac{\sin 0.1}{0.1} \approx \frac{0.0998}{0.1} = 0.9983$
    - $x = 0.01$: $\frac{\sin 0.01}{0.01} \approx \frac{0.0099998}{0.01} = 0.99998$
    - $x = 0.001$: $\frac{\sin 0.001}{0.001} \approx 0.9999998$

- **例子2**: $\lim_{n \to \infty} \frac{1}{n} = 0$
  - 当$n$越来越大时，$\frac{1}{n}$越来越小，最终接近0
  - **数值序列**: $1, 0.5, 0.333..., 0.25, 0.2, 0.166..., 0.142..., 0.125, ...$
  - 对于任意 $\varepsilon > 0$，取 $N > \frac{1}{\varepsilon}$，则 $n > N$ 时 $\left|\frac{1}{n} - 0\right| < \varepsilon$

- **例子3**: $\lim_{x \to 2} (3x + 1) = 7$
  - **数值逼近**:
    - $x = 1.9$: $3(1.9) + 1 = 6.7$
    - $x = 1.99$: $3(1.99) + 1 = 6.97$
    - $x = 2.01$: $3(2.01) + 1 = 7.03$
    - $x = 2.001$: $3(2.001) + 1 = 7.003$

- **例子4**: 用 $\varepsilon$-$\delta$ 定义证明 $\lim_{x \to 2} x^2 = 4$
  - 对于任意 $\varepsilon > 0$，取 $\delta = \min(1, \frac{\varepsilon}{5})$
  - 当 $0 < |x - 2| < \delta$ 时：$|x^2 - 4| = |x-2||x+2| < \delta \cdot 5 \leq \varepsilon$
