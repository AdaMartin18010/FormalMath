...
2. **模性提升**：证明$\rho_{E,\ell}$是模的（对应某个模形式）
3. **Ribet提升**：利用Ribet的模性提升定理
4. **Wiles方法**：通过证明形变环和Hecke代数的同构
5. **结论**：$E$对应模形式$f$，使得$L(E, s) = L(f, s)$
...
2. **Langlands对应**：建立Galois表示和自守表示的对应
3. **几何方法**：使用代数几何和上同调理论
4. **函子性**：证明函子性原理在函数域上成立
5. **结论**：函数域朗兰兹对应成立
...
2. **提升**：通过提升理论建立对应
3. **相对迹公式**：使用相对迹公式研究函子性
4. **几何方法**：在几何Langlands中，函子性有几何解释
5. **开放问题**：一般情况的函子性仍是开放问题
...
4. 阅读[朗兰兹纲领-三视角版](./33-朗兰兹纲领.md) → 了解朗兰兹纲领的历史发展和开放问题
