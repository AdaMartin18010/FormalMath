...
title: Maschke定理 (Maschke's Theorem)
---
...
- 半单代数 (Semisimple Algebra)：半单模上的代数
- 完全可约表示 (Completely Reducible Representation)：直和分解
- 群代数 (Group Algebra)：群的代数化
- Wedderburn-Artin定理 (Wedderburn-Artin Theorem)：半单代数结构
- 特征标表 (Character Table)：表示的数值不变量
...
- [Mathlib4 文档 - Maschke](https://leanprover-community.github.io/mathlib4_docs/Mathlib/RepresentationTheory/Maschke.html)[需更新]
- [Groupprops - Maschke's theorem](https://groupprops.subwiki.org/wiki/Maschke%27s_theorem_for_finite_groups)[需更新]
