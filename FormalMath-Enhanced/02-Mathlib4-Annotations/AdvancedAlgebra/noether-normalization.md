...
- [整扩张](./integral-extension.md)：Noether正规化的核心
- [代数独立性](./algebraic-independence.md)：正规化元的性质
- [Hilbert零点定理](./hilbert-nullstellensatz.md)：Noether正规化的应用
- [超越基](./transcendence-basis.md)：正规化元的几何意义
...
- [Stacks Project - Noether Normalization](https://stacks.math.columbia.edu/tag/00OW)
