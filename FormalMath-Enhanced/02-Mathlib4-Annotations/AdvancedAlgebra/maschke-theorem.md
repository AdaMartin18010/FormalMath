...
external_ids:
  stacks_tag:
    tag: 00C0
    url: https://stacks.math.columbia.edu/tag/00C0
references:
  databases:
  - id: stacks_project
    type: database
    name: Stacks Project
    entry_url: https://stacks.math.columbia.edu/tag/00C0
    tags:
    - 00C0
...
- [GroupProps - Maschke's Theorem][https://groupprops.subwiki.org/wiki/Maschke%27s_theorem](需更新)
- [Stacks Project - Maschke's Theorem][https://stacks.math.columbia.edu/tag/00C0](需更新)
