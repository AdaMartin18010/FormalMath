...
- [完备度量空间](./complete-metric-space.md)：定理的主要适用空间
- [无处稠密集](./nowhere-dense-set.md)："没有内部块"的集合
- [剩余集](./residual-set.md)：包含稠密$G_\delta$集的集合
- [一致有界原理](../Analysis/uniform-boundedness.md)：Baire定理的应用
...
- [Mathlib4 文档 - Baire](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Topology/Baire/CompleteSpace.html)
