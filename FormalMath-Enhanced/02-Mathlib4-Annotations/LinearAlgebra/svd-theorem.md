...
- [特征值分解 (Eigenvalue Decomposition)](./eigenvalue-decomposition.md)：方阵的分解
- [伪逆 (Moore-Penrose Pseudoinverse)](./pseudoinverse.md)：通过 SVD 计算
- [低秩近似 (Low-Rank Approximation)](./low-rank-approximation.md)：截断 SVD
- [谱范数 (Spectral Norm)](./spectral-norm.md)：最大奇异值
- [条件数 (Condition Number)](./condition-number.md)：最大与最小奇异值之比
...
- [Mathlib4 文档 - SVD](https://leanprover-community.github.io/mathlib4_docs/Mathlib/LinearAlgebra/SVD.html)
