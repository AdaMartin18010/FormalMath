...
- [Dilworth定理](./dilworth-theorem.md)：偏序集分解
- [鸽巢原理](./pigeonhole-principle.md)：证明工具
- [凸包](./convex-hull.md)：计算几何概念
...
- [Mathlib4 文档 - List](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Data/List/Basic.html)
