...
- [FormalMath-Enhanced 快速入门指南](#formalmath-enhanced-快速入门指南)
  - [目录](#目录)
  - [1. 项目简介](#1-项目简介)
    - [1.1 什么是FormalMath-Enhanced？](#11-什么是formalmath-enhanced)
    - [1.2 项目结构](#12-项目结构)
    - [1.3 核心使用场景](#13-核心使用场景)
  - [2. 5分钟快速浏览](#2-5分钟快速浏览)
    - [步骤1：了解项目概览（1分钟）](#步骤1了解项目概览1分钟)
    - [步骤2：快速浏览各模块（2分钟）](#步骤2快速浏览各模块2分钟)
    - [步骤3：查看示例文档（2分钟）](#步骤3查看示例文档2分钟)
  - [3. 第一个例子：查找MSC编码](#3-第一个例子查找msc编码)
    - [3.1 任务描述](#31-任务描述)
    - [3.2 查找步骤](#32-查找步骤)
      - [Step 1: 确定大类](#step-1-确定大类)
      - [Step 2: 搜索关键词](#step-2-搜索关键词)
      - [Step 3: 确认次要分类](#step-3-确认次要分类)
      - [Step 4: 应用标注](#step-4-应用标注)
    - [3.3 练习](#33-练习)
  - [4. 第二个例子：阅读定理注释](#4-第二个例子阅读定理注释)
    - [4.1 任务描述](#41-任务描述)
    - [4.2 学习步骤](#42-学习步骤)
      - [Step 1: 找到定理注释](#step-1-找到定理注释)
      - [Step 2: 阅读注释结构](#step-2-阅读注释结构)
    - [4.4 练习](#44-练习)
  - [5. 第三个例子：解一道IMO题](#5-第三个例子解一道imo题)
    - [5.1 任务描述](#51-任务描述)
    - [5.2 解题步骤](#52-解题步骤)
      - [Step 1: 选择题目](#step-1-选择题目)
      - [Step 2: 阅读题目](#step-2-阅读题目)
      - [Step 3: 分析思路](#step-3-分析思路)
      - [Step 4: 查看解答](#step-4-查看解答)
      - [Step 5: 验证与总结](#step-5-验证与总结)
    - [5.3 练习](#53-练习)
  - [6. 下一步学习](#6-下一步学习)
    - [6.1 推荐学习路径](#61-推荐学习路径)
    - [6.2 推荐教程顺序](#62-推荐教程顺序)
    - [6.3 资源链接](#63-资源链接)
  - [常见问题 (FAQ)](#常见问题-faq)
    - [Q1: 我没有Lean编程经验，可以使用这个项目吗？](#q1-我没有lean编程经验可以使用这个项目吗)
    - [Q2: 如何选择从哪个模块开始学习？](#q2-如何选择从哪个模块开始学习)
    - [Q3: 项目多久更新一次？](#q3-项目多久更新一次)
    - [Q4: 如何为项目做贡献？](#q4-如何为项目做贡献)
