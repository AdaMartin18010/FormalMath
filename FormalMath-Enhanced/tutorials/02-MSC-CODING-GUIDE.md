...
- [MSC2020编码使用教程](#msc2020编码使用教程)
  - [目录](#目录)
  - [1. MSC编码体系介绍](#1-msc编码体系介绍)
    - [1.1 什么是MSC？](#11-什么是msc)
    - [1.2 MSC编码的重要性](#12-msc编码的重要性)
    - [1.3 FormalMath-Enhanced的MSC编码覆盖](#13-formalmath-enhanced的msc编码覆盖)
  - [2. MSC编码结构解析](#2-msc编码结构解析)
    - [2.1 编码层级](#21-编码层级)
    - [2.2 顶级分类速查](#22-顶级分类速查)
    - [2.3 编码示例详解](#23-编码示例详解)
  - [3. 如何为自己的论文标注MSC](#3-如何为自己的论文标注msc)
    - [3.1 标注流程](#31-标注流程)
    - [3.2 详细步骤](#32-详细步骤)
      - [Step 1: 分析论文主题](#step-1-分析论文主题)
      - [Step 2: 查找相关编码](#step-2-查找相关编码)
      - [Step 3: 选择主次分类](#step-3-选择主次分类)
      - [Step 4: 应用标注](#step-4-应用标注)
    - [3.3 质量检查清单](#33-质量检查清单)
  - [4. 使用批量标注工具](#4-使用批量标注工具)
    - [4.1 Python批量标注脚本](#41-python批量标注脚本)
    - [4.2 命令行工具](#42-命令行工具)
  - [5. 示例：为代数论文标注](#5-示例为代数论文标注)
    - [5.1 论文信息](#51-论文信息)
    - [5.2 分析步骤](#52-分析步骤)
      - [Step 1: 提取关键词](#step-1-提取关键词)
      - [Step 2: 查找编码](#step-2-查找编码)
      - [Step 3: 确定主次分类](#step-3-确定主次分类)
    - [5.3 应用标注](#53-应用标注)
  - [6. 常见问题与技巧](#6-常见问题与技巧)
    - [6.1 常见问题](#61-常见问题)
      - [Q1: 我的论文涉及多个领域，如何确定主要分类？](#q1-我的论文涉及多个领域如何确定主要分类)
      - [Q2: 找不到完全匹配的编码怎么办？](#q2-找不到完全匹配的编码怎么办)
      - [Q3: 可以自创编码吗？](#q3-可以自创编码吗)
    - [6.2 高级技巧](#62-高级技巧)
      - [技巧1: 交叉领域论文的标注](#技巧1-交叉领域论文的标注)
      - [技巧2: 历史文献的标注](#技巧2-历史文献的标注)
      - [技巧3: 使用注释标注](#技巧3-使用注释标注)
  - [7. 练习题](#7-练习题)
    - [基础练习](#基础练习)
    - [进阶练习](#进阶练习)
    - [实践练习](#实践练习)
  - [附录：核心编码速查表](#附录核心编码速查表)
    - [基础数学 (03-XX)](#基础数学-03-xx)
    - [代数结构](#代数结构)
    - [分析学](#分析学)
    - [几何学](#几何学)
    - [拓扑学](#拓扑学)
