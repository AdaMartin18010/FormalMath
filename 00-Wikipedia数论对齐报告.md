...
- [Wikipedia数论概念结构对齐报告](#wikipedia数论概念结构对齐报告)
  - [目录](#目录)
  - [概述](#概述)
    - [对齐范围](#对齐范围)
    - [对齐原则](#对齐原则)
  - [Wikipedia条目结构分析](#wikipedia条目结构分析)
    - [1. Number Theory (数论)](#1-number-theory-数论)
    - [2. Analytic Number Theory (解析数论)](#2-analytic-number-theory-解析数论)
    - [3. Algebraic Number Theory (代数数论)](#3-algebraic-number-theory-代数数论)
    - [4. Prime Number Theorem (素数定理)](#4-prime-number-theorem-素数定理)
    - [5. Riemann Hypothesis (黎曼假设)](#5-riemann-hypothesis-黎曼假设)
    - [6. Modular Forms (模形式)](#6-modular-forms-模形式)
    - [7. Elliptic Curves (椭圆曲线)](#7-elliptic-curves-椭圆曲线)
    - [8. Diophantine Equations (丢番图方程)](#8-diophantine-equations-丢番图方程)
  - [概念定义对齐](#概念定义对齐)
    - [核心概念对照表](#核心概念对照表)
    - [需要标准化的术语](#需要标准化的术语)
  - [属性关系映射](#属性关系映射)
    ...
    - [前置条件映射](#前置条件映射)
  - [层级结构对比](#层级结构对比)
    - [Wikipedia数论层级](#wikipedia数论层级)
    - [FormalMath当前层级](#formalmath当前层级)
    - [层级对齐差距](#层级对齐差距)
  - [对齐建议](#对齐建议)
    - [短期任务 (P0)](#短期任务-p0)
    - [中期任务 (P1)](#中期任务-p1)
