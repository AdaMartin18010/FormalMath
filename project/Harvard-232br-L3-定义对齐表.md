...
external_ids:
  ...
  - tag: 01LD
    url: https://stacks.math.columbia.edu/tag/01LD
  - tag: 01LH
...
- [Harvard Math 232br Algebraic Geometry L3定义级对齐表](#harvard-math-232br-algebraic-geometry-l3定义级对齐表)
  - [目录](#目录)
  - [1. 课程概述](#1-课程概述)
    - [1.1 Harvard 232br课程定位](#11-harvard-232br课程定位)
    - [1.2 与Hartshorne教材的对应](#12-与hartshorne教材的对应)
  - [2. 定义对齐总表](#2-定义对齐总表)
    - [2.1 核心定义对齐汇总](#21-核心定义对齐汇总)
    - [2.2 对齐统计汇总](#22-对齐统计汇总)
  - [3. 概形与结构层定义详解](#3-概形与结构层定义详解)
    - [3.1 概形 (Scheme)](#31-概形-scheme)
      - [Hartshorne原文 (Ch II, Exercise 2.2)](#hartshorne原文-ch-ii-exercise-22)
      - [FormalMath对应定义](#formalmath对应定义)
      - [符号使用对比](#符号使用对比)
      - [条件等价性分析](#条件等价性分析)
    - [3.2 结构层 (Structure Sheaf)](#32-结构层-structure-sheaf)
      - [Hartshorne原文 (Ch II, Exercise 2.2)](#hartshorne原文-ch-ii-exercise-22-1)
      - [FormalMath对应定义](#formalmath对应定义-1)
      - [与Stacks Project对齐](#与stacks-project对齐)
  - [4. 层论基础定义详解](#4-层论基础定义详解)
    - [4.1 模层 (Sheaf of Modules)](#41-模层-sheaf-of-modules)
      - [Hartshorne原文 (Ch II, Exercise 5.1)](#hartshorne原文-ch-ii-exercise-51)
      - [FormalMath对应定义](#formalmath对应定义-2)
    - [4.2 拟凝聚层与凝聚层](#42-拟凝聚层与凝聚层)
      - [Hartshorne原文 (Ch II, Exercise 5.4)](#hartshorne原文-ch-ii-exercise-54)
      - [FormalMath对应定义](#formalmath对应定义-3)
      - [等价性分析](#等价性分析)
  - [5. 上同调理论定义详解](#5-上同调理论定义详解)
    - [5.1 层上同调 (Sheaf Cohomology)](#51-层上同调-sheaf-cohomology)
      - [Hartshorne原文 (Ch III, Theorem 2.6)](#hartshorne原文-ch-iii-theorem-26)
      - [FormalMath对应定义](#formalmath对应定义-4)
    - [5.2 导出函子 (Derived Functors)](#52-导出函子-derived-functors)
      - [Hartshorne原文 (Ch III, Theorem 1.3)](#hartshorne原文-ch-iii-theorem-13)
      - [FormalMath对应定义](#formalmath对应定义-5)
    - [5.3 Čech上同调](#53-čech上同调)
      - [Hartshorne原文 (Ch III, Theorem 4.5)](#hartshorne原文-ch-iii-theorem-45)
      - [FormalMath对应定义](#formalmath对应定义-6)
  - [6. Serre对偶与Riemann-Roch详解](#6-serre对偶与riemann-roch详解)
    - [6.1 Serre对偶 (Serre Duality)](#61-serre对偶-serre-duality)
      - [Hartshorne原文 (Ch III, Theorem 7.6)](#hartshorne原文-ch-iii-theorem-76)
      - [FormalMath对应定义](#formalmath对应定义-7)
      - [与Hartshorne的差异说明](#与hartshorne的差异说明)
    - [6.2 Riemann-Roch定理](#62-riemann-roch定理)
      - [Hartshorne原文 (Ch IV, Theorem 1.3)](#hartshorne原文-ch-iv-theorem-13)
      - [FormalMath对应定义](#formalmath对应定义-8)
      - [等价性分析](#等价性分析-1)
  - [7. 与MIT 18.726课程对照](#7-与mit-18726课程对照)
    - [7.1 课程覆盖对比](#71-课程覆盖对比)
    - [7.2 定义对齐对照表](#72-定义对齐对照表)
  - [8. Lean4形式化对应](#8-lean4形式化对应)
    - [8.1 核心定义的形式化](#81-核心定义的形式化)
    - [8.2 形式化现状评估](#82-形式化现状评估)
  - [9. 教学建议与核心洞见](#9-教学建议与核心洞见)
    - [9.1 学习路径建议](#91-学习路径建议)
    - [9.2 核心洞见与常见误区](#92-核心洞见与常见误区)
    - [9.3 与Stacks Project的深入对照](#93-与stacks-project的深入对照)
  - [参考文献](#参考文献)
  - [附录：对齐验证清单](#附录对齐验证清单)
