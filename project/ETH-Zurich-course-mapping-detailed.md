...
msc_secondary:
  - 97A99
  - 00A05
title: ETH Zurich数学课程与FormalMath深度映射分析
...
| **[代数几何](../docs/13-代数几何/)** | 从经典到概形理论的欧洲传统 | `数学家理念体系/格洛腾迪克/` |
| **[代数拓扑](../docs/12-代数拓扑/)** | 同调代数和拓扑的深刻联系 | `docs/05-拓扑学/` |
| **[微分几何](../docs/04-几何与拓扑/)** | 黎曼几何与物理应用 | `docs/14-微分几何/` |
...
| **教学语言** | 德语为主 | 英语 | 英语 |
| **基础课程** | 统一严格 | 灵活多样 | 灵活多样 |
| **[代数几何](../docs/13-代数几何/)** | 🏆 苏黎世学派强项 | 优秀 | 🏆 凝聚层上同调专长 |
| **[代数拓扑](../docs/12-代数拓扑/)** | 🏆 欧洲领先 | 优秀 | 优秀 |
...
| ETH课程 | MIT对应 | Harvard对应 | Princeton对应 | 对应程度 |
|---------|---------|-------------|---------------|----------|
| [Linear Algebra](../docs/02-代数结构/) I/II | 18.700-702 | Math 21/23/25 | MAT 217 | ⭐⭐⭐⭐⭐ |
| Analysis I/II | 18.100 | Math 114 | MAT 215 | ⭐⭐⭐⭐⭐ |
| [Algebra I](../docs/02-代数结构/)/II | 18.704-715 | Math 122/123 | MAT 345/346 | ⭐⭐⭐⭐⭐ |
| [Complex Analysis](../docs/03-分析学/) | 18.112 | Math 113 | MAT 330/335 | ⭐⭐⭐⭐⭐ |
| [Functional Analysis](../docs/03-分析学/) | 18.102 | Math 212 | MAT 425 | ⭐⭐⭐⭐ |
| [Algebraic Topology](../docs/12-代数拓扑/) | 18.905 | Math 131/231 | MAT 365 | ⭐⭐⭐⭐⭐ |
| [Differential Geometry](../docs/04-几何与拓扑/) | 18.950 | Math 132/230 | MAT 355 | ⭐⭐⭐⭐⭐ |
| **[Algebraic [Geometry](../docs/04-几何与拓扑/)](../docs/13-代数几何/) I/II** | 18.725/726 | **Math 232ar/br** | **MAT 416** | ⭐⭐⭐⭐⭐ |
| [Number Theory](../docs/05-数论/) I/II | 18.782/783 | Math 223 | MAT 419 | ⭐⭐⭐⭐⭐ |
...
| **[代数几何](../docs/13-代数几何/)** | 苏黎世传统，Hartshorne体系 | Vakil FOAG导向 | Math 232ar/br，与格洛腾迪克完美对应 |
| **[代数拓扑](../docs/12-代数拓扑/)** | 强调同调代数 | 强调几何直观 | 强调几何直观 |
| **[数论](../docs/05-数论/)** | 类域论传统强 | 椭圆曲线、模形式 | 算术几何 |
| **[微分几何](../docs/04-几何与拓扑/)** | Riemann几何经典 | 现代微分几何 | 现代微分几何 |

### 10.3 FormalMath覆盖优势

| 课程领域 | MIT覆盖 | Harvard覆盖 | ETH覆盖 | Princeton覆盖 | 备注 |
|----------|---------|-------------|---------|---------------|------|
| [线性代数](../docs/02-代数结构/) | 90% | 90% | 90% | 92% | 均高 |
| [实分析](../docs/03-分析学/) | 88% | 88% | 90% | 88% | 均高 |
| 代数 | 90% | 90% | 90% | 90% | 均高 |
| [复分析](../docs/03-分析学/) | 85% | 88% | 88% | 85% | 均高 |
| [泛函分析](../docs/03-分析学/) | 82% | 85% | 85% | 72% | 均高 |
| [代数拓扑](../docs/12-代数拓扑/) | 85% | 88% | 88% | 85% | 均高 |
| [微分几何](../docs/04-几何与拓扑/) | 80% | 82% | 82% | 78% | 均高 |
| **[代数几何](../docs/13-代数几何/)** | 75% | **98%** | 78% | 75% | Harvard最优 |
| [数论](../docs/05-数论/) | 80% | 85% | 80% | 70% | 均高 |

### 10.4 与Princeton对比分析

| 维度 | ETH Zurich | Princeton |
|------|------------|-----------|
| **教学语言** | 德语/英语 | 英语 |
| **基础课程** | 统一严格模块化 | 严格证明导向 |
| **[线性代数](../docs/02-代数结构/)** | 德式严格，谱理论强 | 最抽象，证明导向 |
| **分析入门** | Analysis I/II 全面 | MAT 215 纯证明 |
| **[代数几何](../docs/13-代数几何/)** | 苏黎世学派传统 | Kollár双有理几何 |
| **与FormalMath对应** | 85% | 82% |

**ETH 401-3532 vs Princeton MAT 416**:
- 两者都是代数几何高级课程
- ETH 401-3532强调苏黎世学派的系统方法
- Princeton MAT 416强调Kollár的双有理几何研究前沿
- 两课程都与FormalMath格洛腾迪克体系高度对应（75-78%）

**推荐路径**: 
- 偏好**德式严格形式化**选择ETH
- 偏好**证明训练与抽象思维**选择Princeton
- 偏好**凝聚层上同调系统学习**选择Harvard Math 232br

---

## 附录

### A. ETH与Princeton课程官网链接
