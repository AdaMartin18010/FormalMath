...
- [MIT 18.701 Algebra I L4定理级对齐表](#mit-18701-algebra-i-l4定理级对齐表)
  - [目录](#目录)
  - [1. 概述与文档用途](#1-概述与文档用途)
    - [1.1 文档目标](#11-文档目标)
    - [1.2 完整性等级说明](#12-完整性等级说明)
    - [1.3 优先级说明](#13-优先级说明)
    - [1.4 证明完整性评估维度](#14-证明完整性评估维度)
    - [1.5 参考文档](#15-参考文档)
  - [2. 定理对齐总表](#2-定理对齐总表)
    - [2.1 核心定理对齐汇总（8个定理）](#21-核心定理对齐汇总8个定理)
    - [2.2 对齐统计汇总](#22-对齐统计汇总)
  - [3. 拉格朗日定理详解](#3-拉格朗日定理详解)
    - [3.1 Artin教材原文](#31-artin教材原文)
    - [3.2 FormalMath对应陈述](#32-formalmath对应陈述)
    - [3.3 定理陈述对比](#33-定理陈述对比)
    - [3.4 证明思路](#34-证明思路)
    - [3.5 证明步骤详解](#35-证明步骤详解)
    - [3.6 Lean4形式化对应](#36-lean4形式化对应)
  - [4. 同态基本定理详解](#4-同态基本定理详解)
    - [4.1 Artin教材原文](#41-artin教材原文)
    - [4.2 FormalMath对应陈述](#42-formalmath对应陈述)
    - [4.3 定理陈述对比](#43-定理陈述对比)
    - [4.4 证明思路](#44-证明思路)
    - [4.5 证明步骤详解](#45-证明步骤详解)
    - [4.6 Lean4形式化对应](#46-lean4形式化对应)
  - [5. 对应定理详解](#5-对应定理详解)
    - [5.1 Artin教材原文](#51-artin教材原文)
    - [5.2 FormalMath对应陈述](#52-formalmath对应陈述)
    - [5.3 证明思路](#53-证明思路)
    - [5.4 Lean4形式化对应](#54-lean4形式化对应)
  - [6. Sylow第一定理详解](#6-sylow第一定理详解)
    - [6.1 Artin教材原文](#61-artin教材原文)
    - [6.2 FormalMath对应陈述](#62-formalmath对应陈述)
    - [6.3 证明思路（Wielandt证明）](#63-证明思路wielandt证明)
    - [6.4 Lean4形式化对应](#64-lean4形式化对应)
  - [7. 第二同构定理详解](#7-第二同构定理详解)
    - [7.1 Artin教材原文](#71-artin教材原文)
    - [7.2 FormalMath对应陈述](#72-formalmath对应陈述)
    - [7.3 证明思路](#73-证明思路)
  - [8. 第三同构定理详解](#8-第三同构定理详解)
    - [8.1 Artin教材原文](#81-artin教材原文)
    - [8.2 FormalMath对应陈述](#82-formalmath对应陈述)
    - [8.3 证明思路](#83-证明思路)
  - [9. 轨道-稳定化子定理详解](#9-轨道-稳定化子定理详解)
    - [9.1 Artin教材原文](#91-artin教材原文)
    - [9.2 FormalMath对应陈述](#92-formalmath对应陈述)
    - [9.3 Lean4形式化对应](#93-lean4形式化对应)
  - [10. 类方程详解](#10-类方程详解)
    - [10.1 Artin教材原文](#101-artin教材原文)
    - [10.2 FormalMath对应陈述](#102-formalmath对应陈述)
    - [10.3 证明思路](#103-证明思路)
  - [11. 证明技巧总结](#11-证明技巧总结)
    - [11.1 群论证明常用技巧](#111-群论证明常用技巧)
    - [11.2 证明结构模板](#112-证明结构模板)
  - [12. Lean4形式化对应](#12-lean4形式化对应)
    - [12.1 Mathlib中已有的群论形式化](#121-mathlib中已有的群论形式化)
    - [12.2 待建设的Lean4形式化](#122-待建设的lean4形式化)
  - [13. 教学建议](#13-教学建议)
    - [13.1 学习路径](#131-学习路径)
    - [13.2 常见误区](#132-常见误区)
