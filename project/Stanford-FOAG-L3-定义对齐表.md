...
| 定义 | FOAG章节 | Vakil表述特色 | FormalMath对应 | 等价性 | Stacks Tag |
|------|----------|---------------|----------------|--------|------------|
| **范畴 (Category)** | Ch 1 | 强调直观 | `docs/02-代数结构/01-基础结构/范畴论基础.md` | **严格等价** ≡ | [0017](https://stacks.math.columbia.edu/tag/0017) |
| **层 (Sheaf)** | Ch 2 | 几何直觉 | `docs/13-代数几何/02-层论与上同调/01-层论基础-深度版.md` | **严格等价** ≡ | [006T](https://stacks.math.columbia.edu/tag/006T) |
| **局部环化空间** | Ch 3 | 渐进引入 | `docs/13-代数几何/03-概形理论/01-仿射概形-深度版.md` | **严格等价** ≡ | [01HV](https://stacks.math.columbia.edu/tag/01HV) |
| **仿射概形** | Ch 3 | 强调Spec构造 | `docs/13-代数几何/03-概形理论/01-仿射概形-深度版.md` | **严格等价** ≡ | [01HP](https://stacks.math.columbia.edu/tag/01HP) |
| **概形 (Scheme)** | Ch 4 | 逐步构建 | `docs/13-代数几何/03-概形理论/02-概形-深度版.md` | **严格等价** ≡ | [01LC](https://stacks.math.columbia.edu/tag/01LC) |
| **分离态射** | Ch 10 | Valuative Criterion | `docs/13-代数几何/03-概形理论/03-概形态射-深度版.md` | **严格等价** ≡ | [01KY](https://stacks.math.columbia.edu/tag/01KY) |
...
| **射影概形** | Ch 14 | Proj构造 | `docs/13-代数几何/03-概形理论/04-射影概形-深度版.md` | **严格等价** ≡ | [01NS](https://stacks.math.columbia.edu/tag/01NS) |
| **线丛** | Ch 14 | 几何直观 | `docs/13-代数几何/03-概形理论/05-线丛与除子-深度版.md` | **严格等价** ≡ | [01M5](https://stacks.math.columbia.edu/tag/01M5) |
...
### 11.3 与Stacks Project的深入对照

| 主题 | FOAG章节 | Stacks Project | FormalMath建议 |
|------|----------|----------------|----------------|
| 范畴论基础 | Ch 1 | [0017](https://stacks.math.columbia.edu/tag/0017) | 两者等价 |
| 层论 | Ch 2 | [006T](https://stacks.math.columbia.edu/tag/006T) | Stacks更详细 |
| 局部环化空间 | Ch 3 | [01HV](https://stacks.math.columbia.edu/tag/01HV) | 定义等价 |
| 仿射概形 | Ch 3 | [01HP](https://stacks.math.columbia.edu/tag/01HP) | 两者等价 |
| 概形 | Ch 4 | [01LC](https://stacks.math.columbia.edu/tag/01LC) | Stacks更形式化 |
| 分离态射 | Ch 10 | [01KY](https://stacks.math.columbia.edu/tag/01KY) | Vakil更直观 |
...
| 射影概形 | Ch 14 | [01NS](https://stacks.math.columbia.edu/tag/01NS) | Vakil更易入门 |
| 线丛 | Ch 14 | [01M5](https://stacks.math.columbia.edu/tag/01M5) | Stacks更范畴化 |
