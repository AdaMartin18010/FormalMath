...
- [FormalMath与EPFL数学课程对齐报告](#formalmath与epfl数学课程对齐报告)
  ...
  - [三、课程详细对齐分析](#三课程详细对齐分析)
    - [3.1 分析学I-IV (Analyse I-IV)](#31-分析学i-iv-analyse-i-iv)
      ...
      - [MATH-105: Analyse III-IV](#math-105-analyse-iii-iv)
    - [3.2 代数学 (Algèbre)](#32-代数学-algèbre)
      - [MATH-111: Algèbre Linéaire I](#math-111-algèbre-linéaire-i)
      - [MATH-115: Algèbre Linéaire II (Advanced)](#math-115-algèbre-linéaire-ii-advanced)
      - [代数进阶课程](#代数进阶课程)
    - [3.3 几何学 (Géométrie)](#33-几何学-géométrie)
      - [MATH-121: Géométrie (基础几何)](#math-121-géométrie-基础几何)
      - [MATH-213: Géométrie Différentielle I (微分几何I)](#math-213-géométrie-différentielle-i-微分几何i)
    - [3.4 概率统计 (Probabilités et Statistique)](#34-概率统计-probabilités-et-statistique)
      - [MATH-232: Probabilités et Statistique (pour IC)](#math-232-probabilités-et-statistique-pour-ic)
    - [3.5 数值分析 (Analyse Numérique)](#35-数值分析-analyse-numérique)
      - [MATH-319/419: Analyse Numérique I-II](#math-319419-analyse-numérique-i-ii)
  - [四、概念映射表](#四概念映射表)
