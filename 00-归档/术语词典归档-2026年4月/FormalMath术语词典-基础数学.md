...
2. **专业网站**：
   ...
   - [Stanford Encyclopedia of Philosophy](https://plato.stanford.edu/)[需更新] - 哲学和逻辑
...
- **Stanford Encyclopedia of Philosophy**：[Set Theory](https://plato.stanford.edu/entries/set-theory/)[需更新]
...
- **Stanford Encyclopedia of Philosophy**：[Logic](https://plato.stanford.edu/entries/logic/)[需更新]
- **Internet Encyclopedia of Philosophy**：[Logic](https://iep.utm.edu/logic/)[需更新]
...
- **代数数 (Algebraic Number)** - 数系 - $\mathbb{A}$ - 定义

#### B

- **并集 (Union)** - 集合论 - $\cup$ - 定义
- **补集 (Complement)** - 集合论 - $^c$ - 定义

#### C

- **差集 (Set Difference)** - 集合论 - $\setminus$ - 定义
- **重言式 (Tautology)** - 逻辑 - 定义
- **存在量词 (Existential Quantifier)** - 逻辑 - $\exists$ - 定义
- **超越数 (Transcendental Number)** - 数系 - 定义
- **传递性 (Transitivity)** - 关系 - 定义
- **矛盾 (Contradiction)** - 逻辑 - 定义
- **复数 (Complex Number)** - 数系 - $\mathbb{C}$ - 定义

#### D

- **单射 (Injective)** - 函数 - 定义
- **定义域 (Domain)** - 函数 - 定义
- **笛卡尔积 (Cartesian Product)** - 集合论 - $\times$ - 定义
- **等价关系 (Equivalence Relation)** - 关系 - 定义

#### E

- **元素 (Element)** - 集合论 - $\in$ - 定义
- **空集 (Empty Set)** - 集合论 - $\emptyset$ - 定义

#### F

- **反自反性 (Irreflexivity)** - 关系 - 定义
- **反对称性 (Antisymmetry)** - 关系 - 定义
- **复合函数 (Composite Function)** - 函数 - $\circ$ - 定义
- **函数 (Function)** - 函数 - $f: X \to Y$ - 定义
...
- **合取 (Conjunction)** - 逻辑 - $\land$ - 定义

#### I

- **交集 (Intersection)** - 集合论 - $\cap$ - 定义
- **整数 (Integer)** - 数系 - $\mathbb{Z}$ - 定义
- **逆函数 (Inverse Function)** - 函数 - $f^{-1}$ - 定义
- **无理数 (Irrational Number)** - 数系 - 定义
...
- **逻辑连接词 (Logical Connectives)** - 逻辑 - 定义
...
- **自然数 (Natural Number)** - 数系 - $\mathbb{N}$ - 定义
- **逆函数 (Inverse Function)** - 函数 - $f^{-1}$ - 定义
- **逆关系 (Inverse Relation)** - 关系 - $R^{-1}$ - 定义

#### P

- **偏序关系 (Partial Order)** - 关系 - $\leq$ - 定义
- **幂集 (Power Set)** - 集合论 - $\mathcal{P}$ - 定义
- **皮亚诺公理 (Peano Axioms)** - 数系 - 定义
- **命题 (Proposition)** - 逻辑 - 定义
- **谓词 (Predicate)** - 逻辑 - 定义

#### Q

- **全称量词 (Universal Quantifier)** - 逻辑 - $\forall$ - 定义
- **全序关系 (Total Order)** - 关系 - 定义
- **有理数 (Rational Number)** - 数系 - $\mathbb{Q}$ - 定义

#### R

- **实数 (Real Number)** - 数系 - $\mathbb{R}$ - 定义
- **限制函数 (Restriction)** - 函数 - $f|_A$ - 定义

#### S

- **双射 (Bijective)** - 函数 - 定义
- **对称差 (Symmetric Difference)** - 集合论 - $\triangle$ - 定义
- **对称性 (Symmetry)** - 关系 - 定义
- **子集 (Subset)** - 集合论 - $\subseteq$ - 定义

#### T

- **真值 (Truth Value)** - 逻辑 - 定义

#### W

- **唯一存在量词 (Unique Existential Quantifier)** - 逻辑 - $\exists!$ - 定义

#### X

- **析取 (Disjunction)** - 逻辑 - $\lor$ - 定义
- **限制函数 (Restriction)** - 函数 - $f|_A$ - 定义

#### Y

- **延拓函数 (Extension)** - 函数 - 定义

#### Z

- **值域 (Range)** - 函数 - 定义
- **自反性 (Reflexivity)** - 关系 - 定义
...
- **集合 (Set)** - $\{ \}$ - 定义
- **元素 (Element)** - $\in$ - 定义
- **子集 (Subset)** - $\subseteq$ - 定义
- **并集 (Union)** - $\cup$ - 定义
- **交集 (Intersection)** - $\cap$ - 定义
- **差集 (Set Difference)** - $\setminus$ - 定义
- **补集 (Complement)** - $^c$ - 定义
- **幂集 (Power Set)** - $\mathcal{P}$ - 定义
- **笛卡尔积 (Cartesian Product)** - $\times$ - 定义
- **对称差 (Symmetric Difference)** - $\triangle$ - 定义
- **空集 (Empty Set)** - $\emptyset$ - 定义

#### 数系术语 / Number System Terms

- **自然数 (Natural Number)** - $\mathbb{N}$ - 定义
- **整数 (Integer)** - $\mathbb{Z}$ - 定义
- **有理数 (Rational Number)** - $\mathbb{Q}$ - 定义
- **实数 (Real Number)** - $\mathbb{R}$ - 定义
- **复数 (Complex Number)** - $\mathbb{C}$ - 定义
- **无理数 (Irrational Number)** - 定义
- **代数数 (Algebraic Number)** - $\mathbb{A}$ - 定义
- **超越数 (Transcendental Number)** - 定义
- **虚数单位 (Imaginary Unit)** - $i$ - 定义
- **皮亚诺公理 (Peano Axioms)** - 定义

#### 逻辑术语 / Logic Terms

- **命题 (Proposition)** - 定义
- **逻辑连接词 (Logical Connectives)** - 定义
- **合取 (Conjunction)** - $\land$ - 定义
- **析取 (Disjunction)** - $\lor$ - 定义
- **否定 (Negation)** - $\neqg$ - 定义
- **蕴含 (Implication)** - $\implies$ - 定义
- **等价 (Equivalence)** - $\iff$ - 定义
- **真值 (Truth Value)** - 定义
- **矛盾 (Contradiction)** - 定义
- **重言式 (Tautology)** - 定义
- **谓词 (Predicate)** - 定义
- **全称量词 (Universal Quantifier)** - $\forall$ - 定义
- **存在量词 (Existential Quantifier)** - $\exists$ - 定义
- **唯一存在量词 (Unique Existential Quantifier)** - $\exists!$ - 定义

#### 函数术语 / Function Terms

- **函数 (Function)** - $f: X \to Y$ - 定义
- **定义域 (Domain)** - 定义
- **值域 (Range)** - 定义
- **单射 (Injective)** - 定义
- **满射 (Surjective)** - 定义
- **双射 (Bijective)** - 定义
- **复合函数 (Composite Function)** - $\circ$ - 定义
- **逆函数 (Inverse Function)** - $f^{-1}$ - 定义
- **限制函数 (Restriction)** - $f|_A$ - 定义
...
- **对称性 (Symmetry)** - 定义
- **传递性 (Transitivity)** - 定义
- **等价关系 (Equivalence Relation)** - 定义
- **偏序关系 (Partial Order)** - $\leq$ - 定义
- **全序关系 (Total Order)** - 定义
- **逆关系 (Inverse Relation)** - $R^{-1}$ - 定义
