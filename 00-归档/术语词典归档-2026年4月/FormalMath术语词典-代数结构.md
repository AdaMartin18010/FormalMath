...
|---------|---------|---------|----------|
| 阿贝尔群 | Abelian Group | 群论 | 群论术语-基本概念 |
| 阿廷环 | Artinian Ring | 环论 | 环论术语-特殊环类 |
| 伴随函子 | Adjoint Functor | 范畴论 | 范畴论术语-函子 |

#### B

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 半单李代数 | Semisimple Lie Algebra | 李代数 | 李代数术语-特殊李代数 |
| 半直积 | Semidirect Product | 群论 | 群论术语-结构理论 |
| 本原元 | Primitive Element | 域论 | 域论术语-域扩张 |
| 标准形 | Canonical Form | 模论 | 模论术语-特殊模 |

#### C

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 超代数 | Superalgebra | 李代数 | 李代数术语-特殊李代数 |
| 乘积 | Product | 范畴论 | 范畴论术语-极限与余极限 |
| 初等扩张 | Elementary Extension | 域论 | 域论术语-域扩张 |
| 除环 | Division Ring | 环论 | 环论术语-特殊环类 |

#### D

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 单射 | Monomorphism | 范畴论 | 范畴论术语-特殊态射 |
| 单李代数 | Simple Lie Algebra | 李代数 | 李代数术语-特殊李代数 |
| 导子 | Derivation | 环论 | 环论术语-特殊环类 |
| 等价 | Equivalence | 范畴论 | 范畴论术语-特殊范畴 |

#### E

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 二面体群 | Dihedral Group | 群论 | 群论术语-特殊群 |

#### F

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 反变函子 | Contravariant Functor | 范畴论 | 范畴论术语-函子 |
| 分式域 | Field of Fractions | 环论 | 环论术语-局部化 |
| 分裂域 | Splitting Field | 域论 | 域论术语-域扩张 |
| 平坦模 | Flat Module | 模论 | 模论术语-特殊模 |

#### G

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 伽罗瓦群 | Galois Group | 域论 | 域论术语-Galois理论 |
| 伽罗瓦扩张 | Galois Extension | 域论 | 域论术语-Galois理论 |
| 共变函子 | Covariant Functor | 范畴论 | 范畴论术语-函子 |
| 共轭 | Conjugation | 群论 | 群论术语-子群 |

#### H

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 核 | Kernel | 群论/环论/模论 | 群论术语-群同态 |
| 合成列 | Composition Series | 群论 | 群论术语-结构理论 |
| 环 | Ring | 环论 | 环论术语-基本概念 |
| 换位子 | Commutator | 群论 | 群论术语-结构理论 |
...
|---------|---------|---------|----------|
| 理想 | Ideal | 环论 | 环论术语-理想 |
| 内射模 | Injective Module | 模论 | 模论术语-特殊模 |
| 同构 | Isomorphism | 群论/环论/模论 | 群论术语-群同态 |

#### J

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 交换环 | Commutative Ring | 环论 | 环论术语-基本概念 |
| 交换群 | Commutative Group | 群论 | 群论术语-基本概念 |
| 结合律 | Associativity | 群论/环论 | 群论术语-基本概念 |

#### K

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 可解群 | Solvable Group | 群论 | 群论术语-结构理论 |
| 可分扩张 | Separable Extension | 域论 | 域论术语-域扩张 |
| 可逆元 | Unit | 环论 | 环论术语-基本概念 |

#### L

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 李代数 | Lie Algebra | 李代数 | 李代数术语-基本概念 |
| 李括号 | Lie Bracket | 李代数 | 李代数术语-基本概念 |
| 理想 | Ideal | 环论 | 环论术语-理想 |
| 零因子 | Zero Divisor | 环论 | 环论术语-基本概念 |
| 流形 | Manifold | 李代数 | 李代数术语-基本概念 |
| 局部化 | Localization | 环论 | 环论术语-局部化 |

#### M

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 模 | Module | 模论 | 模论术语-基本概念 |
| 满射 | Epimorphism | 范畴论 | 范畴论术语-特殊态射 |
| 幂零群 | Nilpotent Group | 群论 | 群论术语-结构理论 |
...
|---------|---------|---------|----------|
| 内射模 | Injective Module | 模论 | 模论术语-特殊模 |
| 诺特环 | Noetherian Ring | 环论 | 环论术语-特殊环类 |
| 诺特模 | Noetherian Module | 模论 | 模论术语-模的生成与有限性 |
| 内射模 | Injective Module | 模论 | 模论术语-特殊模 |
...
| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 欧几里得整环 | Euclidean Domain | 环论 | 环论术语-特殊环类 |

#### P

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 偏序 | Partial Order | 范畴论 | 范畴论术语-特殊范畴 |
| 平凡群 | Trivial Group | 群论 | 群论术语-基本概念 |
| 平坦模 | Flat Module | 模论 | 模论术语-特殊模 |
| 投射模 | Projective Module | 模论 | 模论术语-特殊模 |

#### Q

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 群 | Group | 群论 | 群论术语-基本概念 |
| 群作用 | Group Action | 群论 | 群论术语-群作用 |
| 群同态 | Group Homomorphism | 群论 | 群论术语-群同态 |
| 商群 | Quotient Group | 群论 | 群论术语-子群 |
| 商环 | Quotient Ring | 环论 | 环论术语-理想 |
| 商模 | Quotient Module | 模论 | 模论术语-子模与商模 |

#### R

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 群表示 | Group Representation | 群论 | 群论术语-群表示 |
| 李代数表示 | Lie Algebra Representation | 李代数 | 李代数术语-李代数的表示论 |

#### S

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 生成元 | Generator | 群论/模论 | 群论术语-基本概念 |
| 双射 | Isomorphism | 范畴论 | 范畴论术语-特殊态射 |
| 四元数群 | Quaternion Group | 群论 | 群论术语-特殊群 |
| 素理想 | Prime Ideal | 环论 | 环论术语-理想 |
...
|---------|---------|---------|----------|
| 同构 | Isomorphism | 群论/环论/模论 | 群论术语-群同态 |
| 同态 | Homomorphism | 群论/环论/模论 | 群论术语-群同态 |
| 同调 | Homology | 模论 | 模论术语-同调代数 |
| 投射模 | Projective Module | 模论 | 模论术语-特殊模 |
| 特征标 | Character | 群论 | 群论术语-群表示 |

#### U

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 唯一分解整环 | Unique Factorization Domain | 环论 | 环论术语-特殊环类 |
| 单位元 | Identity Element | 群论/环论 | 群论术语-基本概念 |

#### V

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 向量空间 | Vector Space | 模论 | 模论术语-基本概念 |

#### W

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 外积 | Exterior Product | 模论 | 模论术语-张量积 |
| 完全可约 | Completely Reducible | 群论 | 群论术语-群表示 |

#### X

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 西洛子群 | Sylow Subgroup | 群论 | 群论术语-结构理论 |
| 限制 | Restriction | 群论 | 群论术语-群同态 |
| 线性表示 | Linear Representation | 群论 | 群论术语-群表示 |

#### Y

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 域 | Field | 域论 | 域论术语-基本概念 |
| 域扩张 | Field Extension | 域论 | 域论术语-域扩张 |
| 有限群 | Finite Group | 群论 | 群论术语-基本概念 |
| 有限域 | Finite Field | 域论 | 域论术语-有限域 |
| 有限生成模 | Finitely Generated Module | 模论 | 模论术语-模的生成与有限性 |
| 有向图 | Directed Graph | 范畴论 | 范畴论术语-特殊范畴 |

#### Z

| 中文术语 | 英文术语 | 所属分支 | 页码/链接 |
|---------|---------|---------|----------|
| 正规子群 | Normal Subgroup | 群论 | 群论术语-子群 |
| 整环 | Integral Domain | 环论 | 环论术语-基本概念 |
| 主理想 | Principal Ideal | 环论 | 环论术语-理想 |
| 主理想整环 | Principal Ideal Domain | 环论 | 环论术语-特殊环类 |
| 直积 | Direct Product | 群论 | 群论术语-结构理论 |
| 直和 | Direct Sum | 模论 | 模论术语-特殊模 |
| 张量积 | Tensor Product | 模论 | 模论术语-张量积 |
| 自然变换 | Natural Transformation | 范畴论 | 范畴论术语-自然变换 |
| 子群 | Subgroup | 群论 | 群论术语-子群 |
| 子环 | Subring | 环论 | 环论术语-基本概念 |
| 子模 | Submodule | 模论 | 模论术语-子模与商模 |
| 子域 | Subfield | 域论 | 域论术语-基本概念 |
| 子代数 | Subalgebra | 李代数 | 李代数术语-子代数与理想 |
| 自由模 | Free Module | 模论 | 模论术语-特殊模 |
| 自由群 | Free Group | 群论 | 群论术语-结构理论 |
| 自同构 | Automorphism | 群论/环论/域论 | 群论术语-群同态 |
| 自同态 | Endomorphism | 群论/环论/模论 | 群论术语-群同态 |
| 左理想 | Left Ideal | 环论 | 环论术语-理想 |
| 右理想 | Right Ideal | 环论 | 环论术语-理想 |
| 循环群 | Cyclic Group | 群论 | 群论术语-基本概念 |
...
|---------|------|------|------|
| 群 | Group | $G$ | 群 |
| 子群 | Subgroup | $H \leq G$ | 子群 |
| 正规子群 | Normal Subgroup | $N \triangleleft G$ | 正规子群 |
| 商群 | Quotient Group | $G/N$ | 商群 |
| 群同态 | Group Homomorphism | $f: G \to H$ | 群同态 |
| 群同构 | Group Isomorphism | $G \cong H$ | 群同构 |
| 循环群 | Cyclic Group | $\mathbb{Z}_n$ | 循环群 |
| 阿贝尔群 | Abelian Group | - | 阿贝尔群 |
| 对称群 | Symmetric Group | $S_n$ | 对称群 |
| 群作用 | Group Action | $G \curvearrowright X$ | 群作用 |
...
|---------|------|------|------|
| 环 | Ring | $R$ | 环 |
| 交换环 | Commutative Ring | - | 交换环 |
| 整环 | Integral Domain | - | 整环 |
| 域 | Field | $\mathbb{F}$ | 域 |
| 理想 | Ideal | $I \trianglelefteq R$ | 理想 |
| 主理想 | Principal Ideal | $(a)$ | 主理想 |
| 商环 | Quotient Ring | $R/I$ | 商环 |
| 局部化 | Localization | $S^{-1}R$ | 局部化 |
| 分式域 | Field of Fractions | $\operatorname{Frac}(R)$ | 分式域 |
| 诺特环 | Noetherian Ring | - | 诺特环 |
...
|---------|------|------|------|
| 域 | Field | $\mathbb{F}$ | 域 |
| 子域 | Subfield | $K \subseteq F$ | 子域 |
| 域扩张 | Field Extension | $F/K$ | 域扩张 |
| 扩张次数 | Extension Degree | $[F:K]$ | 扩张次数 |
| 有限扩张 | Finite Extension | - | 有限扩张 |
| 代数扩张 | Algebraic Extension | - | 代数扩张 |
| 分裂域 | Splitting Field | - | 分裂域 |
| Galois群 | Galois Group | $\operatorname{Gal}(F/K)$ | 伽罗瓦群 |
| Galois扩张 | Galois Extension | - | 伽罗瓦扩张 |
| 有限域 | Finite Field | $\mathbb{F}_q$ | 有限域 |

#### 模论术语速查 / Module Theory Quick Reference

| 核心术语 | 英文 | 符号 | 链接 |
|---------|------|------|------|
| 模 | Module | $_R M$ 或 $M_R$ | 模 |
| 子模 | Submodule | $N \subseteq M$ | 子模 |
| 商模 | Quotient Module | $M/N$ | 商模 |
| 模同态 | Module Homomorphism | $f: M \to N$ | 模同态 |
| 自由模 | Free Module | $R^{(I)}$ | 自由模 |
| 投射模 | Projective Module | - | 投射模 |
| 内射模 | Injective Module | - | 内射模 |
| 平坦模 | Flat Module | - | 平坦模 |
| 张量积 | Tensor Product | $M \otimes_R N$ | 张量积 |
| 有限生成模 | Finitely Generated Module | - | 有限生成模 |

#### 李代数术语速查 / Lie Algebra Quick Reference

| 核心术语 | 英文 | 符号 | 链接 |
|---------|------|------|------|
| 李代数 | Lie Algebra | $\mathfrak{g}$ | 李代数 |
| 李括号 | Lie Bracket | $[\cdot, \cdot]$ | 李括号 |
| 子代数 | Subalgebra | $\mathfrak{h} \subseteq \mathfrak{g}$ | 子代数 |
| 理想 | Ideal | $\mathfrak{i} \trianglelefteq \mathfrak{g}$ | 理想 |
| 一般线性李代数 | General Linear Lie Algebra | $\mathfrak{gl}_n$ | 一般线性李代数 |
| 特殊线性李代数 | Special Linear Lie Algebra | $\mathfrak{sl}_n$ | 特殊线性李代数 |
| 正交李代数 | Orthogonal Lie Algebra | $\mathfrak{so}_n$ | 正交李代数 |
| 半单李代数 | Semisimple Lie Algebra | - | 半单李代数 |
| 单李代数 | Simple Lie Algebra | - | 单李代数 |
| 李代数表示 | Lie Algebra Representation | $\rho: \mathfrak{g} \to \mathfrak{gl}(V)$ | 李代数表示 |

#### 范畴论术语速查 / Category Theory Quick Reference

| 核心术语 | 英文 | 符号 | 链接 |
|---------|------|------|------|
| 范畴 | Category | $\mathcal{C}$ | 范畴 |
| 对象 | Object | $\text{Ob}(\mathcal{C})$ | 对象 |
| 态射 | Morphism | $\text{Hom}(A, B)$ | 态射 |
| 函子 | Functor | $F: \mathcal{C} \to \mathcal{D}$ | 函子 |
| 共变函子 | Covariant Functor | - | 共变函子 |
| 反变函子 | Contravariant Functor | - | 反变函子 |
| 自然变换 | Natural Transformation | $\eta: F \Rightarrow G$ | 自然变换 |
| 伴随函子 | Adjoint Functor | $F \dashv G$ | 伴随函子 |
| 极限 | Limit | $\lim$ | 极限 |
| 余极限 | Colimit | $\text{colim}$ | 余极限 |
...
| 术语 | 英文 | 所属分支 | 链接 |
|------|------|---------|------|
| 群同态 | Group Homomorphism | 群论 | 群同态 |
| 环同态 | Ring Homomorphism | 环论 | 环同态 |
| 模同态 | Module Homomorphism | 模论 | 模同态 |
| 李代数同态 | Lie Algebra Homomorphism | 李代数 | 李代数同态 |
| 群同构 | Group Isomorphism | 群论 | 群同构 |
| 自同构 | Automorphism | 群论/环论/域论 | 自同构 |
| 自同态 | Endomorphism | 群论/环论/模论 | 自同态 |

#### 商结构相关术语 / Quotient Structure Related Terms

| 术语 | 英文 | 所属分支 | 链接 |
|------|------|---------|------|
| 商群 | Quotient Group | 群论 | 商群 |
| 商环 | Quotient Ring | 环论 | 商环 |
| 商模 | Quotient Module | 模论 | 商模 |
| 正规子群 | Normal Subgroup | 群论 | 正规子群 |
| 理想 | Ideal | 环论 | 理想 |
| 子模 | Submodule | 模论 | 子模 |
...
| 术语 | 英文 | 所属分支 | 链接 |
|------|------|---------|------|
| 自由模 | Free Module | 模论 | 自由模 |
| 投射模 | Projective Module | 模论 | 投射模 |
| 内射模 | Injective Module | 模论 | 内射模 |
| 平坦模 | Flat Module | 模论 | 平坦模 |
| 有限生成模 | Finitely Generated Module | 模论 | 有限生成模 |
| 诺特模 | Noetherian Module | 模论 | 诺特模 |
...
2. **专业网站**：
   ...
   - [Stacks Project](https://stacks.math.columbia.edu/)[需更新] - 代数几何和交换代数

3. **形式化数学**：
   - [Lean 4](https://leanprover.github.io/) - 定理证明器
   - [Coq](https://coq.inria.fr/)[需更新] - 证明助手
   - [Agda](https://agda.readthedocs.io/)[需更新] - 依赖类型编程语言
...
- Milne, J. S. [Algebraic Number Theory](https://www.jmilne.org/math/)[需更新]
- Vakil, R. [The Rising Sea](https://math.stanford.edu/~vakil/216blog/)
- Riehl, E. [Category Theory in Context](https://emilyriehl.github.io/books/)[需更新]
