...
| 渠道 | 用途 | 链接 |
|------|------|------|
| GitHub Issues | Bug 报告、功能请求 | [Issues](https://github.com/formalmath/formalmath/issues) |
| GitHub Discussions | 一般讨论、问答 | [Discussions](https://github.com/formalmath/formalmath/discussions) |
| Pull Requests | 代码/内容审核 | [PRs](https://github.com/formalmath/formalmath/pulls) |
...
- 💬 GitHub Discussions：[参与讨论](https://github.com/formalmath/formalmath/discussions)
- 🐛 Issue 报告：[提交 Issue](https://github.com/formalmath/formalmath/issues/new/choose)
...
- [ ] 知识层次标注正确（L0-L4）
- [ ] 数学公式使用 LaTeX 格式（`$...$` 或 `$$...$$`）
- [ ] 术语使用符合 [多语言术语对照表](./00-标准术语表-8语言.md)
- [ ] 引用来源正确标注
- [ ] 无拼写/语法错误
- [ ] 链接可正常访问
...
| [多语言术语对照表](./00-标准术语表-8语言.md) | 术语标准化参考 |
...
| Markdown 指南 | https://www.markdownguide.org/[需更新] |
