...
- [Abel范畴与同调代数：范畴论的应用](#abel范畴与同调代数范畴论的应用)
  ...
  - [九、数学公式总结](#九数学公式总结)
    - [核心公式](#核心公式)
  - [十、Abel范畴与同调代数的详细数学表述](#十abel范畴与同调代数的详细数学表述)
    - [10.1 Abel范畴的严格定义](#101-abel范畴的严格定义)
    - [10.2 导出函子的严格定义](#102-导出函子的严格定义)
    - [10.3 Ext和Tor函子的严格定义](#103-ext和tor函子的严格定义)
  - [十一、Abel范畴与同调代数在概形理论中的应用](#十一abel范畴与同调代数在概形理论中的应用)
    - [11.1 层上同调](#111-层上同调)
    - [11.2 推前上同调](#112-推前上同调)
  - [历史与渊源（对齐）](#历史与渊源对齐)
  - [姊妹篇与网络资源](#姊妹篇与网络资源)
...
- **Abel 范畴**：核、余核、正合列；Weibel、Mac Lane、Stacks 05NM 与本文一致。
- **同调代数**：Ext、Tor、导出函子；Weibel、Stacks 06XP。
- **概形与 Abel 层**：拟凝聚层、推前上同调；EGA III、Stacks 01HD。

## 姊妹篇与网络资源

- **本目录**：[09-加法范畴与Abel范畴](./09-加法范畴与Abel范畴.md)、[10-同调函子与导出函子](./10-同调函子与导出函子.md)、[07-三角范畴与导出范畴](./07-三角范畴与导出范畴.md)、[14-同调代数与导出函子](./14-同调代数与导出函子.md)。
- **02-概形理论**：[05-拟凝聚层与凝聚层](../02-概形理论/05-拟凝聚层与凝聚层.md)。
- **网络资源**：Stacks Project tag 05NM、06XP、01HD；Weibel；Mac Lane。
