...
- **内部逻辑**：Topos 的内部语言、类型与命题；Mac Lane–Moerdijk、nLab "internal logic" 与本文一致。
- **几何逻辑**：几何公式、有限合取与存在量词；Johnstone Sketches of an Elephant、Stacks 0D4C。
- **子对象分类器与逻辑运算**：合取、析取、蕴含在 topos 中的解释；SGA 4、nLab "geometric logic"。

## 姊妹篇与网络资源

- **本目录**：[01-Grothendieck Topos](./01-Grothendieck%20Topos.md)、[03-几何态射与逻辑态射](./03-几何态射与逻辑态射.md)、[12-内部逻辑的语义学](./12-内部逻辑的语义学.md)。
- **网络资源**：Stacks Project tag 0D4C；Mac Lane–Moerdijk Sheaves in geometry and logic；nLab internal logic、geometric logic。
