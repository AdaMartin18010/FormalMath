...
- [分类定理与Topos分类：Grothendieck的拓扑分类](#分类定理与topos分类grothendieck的拓扑分类)
  ...
  - [二、Topos分类](#二topos分类)
    - [2.1 分类方法](#21-分类方法)
    - [2.2 例子](#22-例子)
  - [三、Grothendieck拓扑分类](#三grothendieck拓扑分类)
    - [3.1 拓扑分类](#31-拓扑分类)
    - [3.2 性质](#32-性质)
  ...
  - [九、数学公式总结](#九数学公式总结)
    - [核心公式](#核心公式)
  - [十、分类定理与Topos分类的详细数学表述](#十分类定理与topos分类的详细数学表述)
    - [10.1 分类方法的构造](#101-分类方法的构造)
    - [10.2 特殊Topos的分类](#102-特殊topos的分类)
    - [10.3 分类定理的唯一性与Topos分类](#103-分类定理的唯一性与topos分类)
