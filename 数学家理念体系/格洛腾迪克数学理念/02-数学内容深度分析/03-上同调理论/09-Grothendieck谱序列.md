---
title: Grothendieck谱序列：上同调计算的强大工具
msc_primary: 01A60
msc_secondary:
- 01A65
- 01A70
...
- **Grothendieck 谱序列**：E_2^{p,q}=H^p(X,R^q f_* F)、收敛到 H^{p+q}；Godement、Stacks 01FQ 与本文一致。
- **退化条件**：E_r^{p,q}=0 则 H^n 同构于 E_r^{p_0,n-p_0}；Weibel、Stacks 01FP。
- **应用**：函子复合、计算上同调；Godement、Weibel。
