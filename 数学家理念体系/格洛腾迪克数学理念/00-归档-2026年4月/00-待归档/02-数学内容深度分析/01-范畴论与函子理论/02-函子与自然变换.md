...
- [函子与自然变换：范畴间的映射](#函子与自然变换范畴间的映射)
  ...
  - [九、数学公式总结](#九数学公式总结)
    - [核心公式](#核心公式)
  - [十、函子与自然变换的详细数学表述](#十函子与自然变换的详细数学表述)
    - [10.1 函子的严格定义](#101-函子的严格定义)
    - [10.2 自然变换的严格定义](#102-自然变换的严格定义)
  - [十一、函子与自然变换在概形理论中的应用](#十一函子与自然变换在概形理论中的应用)
    - [11.1 伴随函子对](#111-伴随函子对)
    - [11.2 函子范畴](#112-函子范畴)
  - [历史与渊源（对齐）](#历史与渊源对齐)
  - [姊妹篇与网络资源](#姊妹篇与网络资源)
...
- **函子**：协变/反变函子、函子范畴 [C,D]；Mac Lane CWM、Stacks 001B 与本文一致。
- **自然变换**：η:F⇒G、自然同构；Mac Lane CWM、Stacks 001C。
- **等价**：范畴等价、自然同构刻画；Mac Lane CWM、nLab。

## 姊妹篇与网络资源

- **本目录**：[01-范畴基础理论](./01-范畴基础理论.md)、[04-伴随与等价](./04-伴随与等价.md)、[05-Yoneda引理与可表函子](./05-Yoneda引理与可表函子.md)、[08-预层与层化](./08-预层与层化.md)。
- **02-概形理论**：[02-概形定义与构造](../02-概形理论/02-概形定义与构造.md)。
- **网络资源**：Stacks Project tag 001B、001C；Mac Lane CWM；nLab functor。
