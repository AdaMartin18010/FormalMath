---
title: 上同调与Mayer-Vietoris序列：覆盖的上同调
msc_primary: 01
msc_secondary:
  - 01A60
  - 01A65
...
- [上同调与Mayer-Vietoris序列：覆盖的上同调](#上同调与mayer-vietoris序列覆盖的上同调)
  ...
  - [七、数学公式总结](#七数学公式总结)
    - [核心公式](#核心公式)
  - [十、Mayer-Vietoris序列的严格数学表述](#十mayer-vietoris序列的严格数学表述)
    - [10.1 Mayer-Vietoris序列的严格构造](#101-mayer-vietoris序列的严格构造)
    - [10.2 Mayer-Vietoris序列与Čech上同调](#102-mayer-vietoris序列与čech上同调)
  - [十一、Mayer-Vietoris序列在概形理论中的应用](#十一mayer-vietoris序列在概形理论中的应用)
    - [11.1 Mayer-Vietoris序列与上同调计算](#111-mayer-vietoris序列与上同调计算)
    - [11.2 Mayer-Vietoris序列与Čech上同调](#112-mayer-vietoris序列与čech上同调)
  - [十二、Mayer-Vietoris序列的现代发展](#十二mayer-vietoris序列的现代发展)
    - [12.1 导出Mayer-Vietoris序列](#121-导出mayer-vietoris序列)
    - [12.2 Mayer-Vietoris序列的应用](#122-mayer-vietoris序列的应用)
  - [历史与渊源（对齐）](#历史与渊源对齐)
  - [姊妹篇与网络资源](#姊妹篇与网络资源)
...
- **Mayer-Vietoris 序列**：开覆盖 U∪V、长正合列、H^i(X) 与 H^i(U)、H^i(V)、H^i(U∩V)；Godement、Hartshorne III.2、Stacks 01ES 与本文一致。
- **粘合**：从局部上同调到整体、Cech 与 MV；Stacks 01ES、01X9。
- **应用**：计算上同调、覆盖与粘合；Hartshorne III.2、Stacks 01ES。

## 姊妹篇与网络资源

- **本目录**：[01-层上同调基础](./01-层上同调基础.md)、[14-上同调与局部化](./14-上同调与局部化.md)、[17-Cech上同调与层上同调](./17-Cech上同调与层上同调.md)。
- **02-概形理论**：[14-概形的粘合与构造](../02-概形理论/14-概形的粘合与构造.md)。
- **网络资源**：Stacks Project tag 01ES、01X9；Godement；Hartshorne III.2。
