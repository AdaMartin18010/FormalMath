...
- **最小可运行示例（P^1 → Spec k 的 Leray 谱序列）**：[docs/工作示例/02-计算示例/14-谱序列与Leray-P1最小示例-工作示例.md](../../../../docs/工作示例/02-计算示例/14-谱序列与Leray-P1最小示例-工作示例.md)（E_2 页与收敛的完整计算）。
- **思维表征与自测要点**：[05-谱序列与Leray谱序列-思维表征](./05-谱序列与Leray谱序列-思维表征.md)（含先修/下游、自测要点、建议复习间隔、最小可运行示例简述）。
