...
- [上同调与Ext函子应用：同调代数的几何应用](#上同调与ext函子应用同调代数的几何应用)
  ...
  - [八、数学公式总结](#八数学公式总结)
    - [核心公式](#核心公式)
  - [十、Ext函子应用的严格数学表述](#十ext函子应用的严格数学表述)
    - [10.1 Ext函子的严格构造](#101-ext函子的严格构造)
    - [10.2 Ext与上同调关系的应用](#102-ext与上同调关系的应用)
  - [十一、Ext函子应用在概形理论中的应用](#十一ext函子应用在概形理论中的应用)
    - [11.1 Ext函子应用与形变理论](#111-ext函子应用与形变理论)
    - [11.2 Ext函子应用与Serre对偶](#112-ext函子应用与serre对偶)
  - [十二、Ext函子应用的现代发展](#十二ext函子应用的现代发展)
    - [12.1 导出Ext函子应用](#121-导出ext函子应用)
    - [12.2 Ext函子应用的应用](#122-ext函子应用的应用)
  - [历史与渊源（对齐）](#历史与渊源对齐)
  - [姊妹篇与网络资源](#姊妹篇与网络资源)
