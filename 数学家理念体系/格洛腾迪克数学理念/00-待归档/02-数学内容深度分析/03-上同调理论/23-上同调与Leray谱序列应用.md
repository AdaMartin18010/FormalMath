...
- [上同调与Leray谱序列应用：计算的高级工具](#上同调与leray谱序列应用计算的高级工具)
  ...
  - [十一、Leray谱序列应用在概形理论中的应用](#十一leray谱序列应用在概形理论中的应用)
    - [11.1 Leray谱序列应用与上同调计算](#111-leray谱序列应用与上同调计算)
    - [11.2 Leray谱序列应用与基变化](#112-leray谱序列应用与基变化)
  - [十二、Leray谱序列应用的现代发展](#十二leray谱序列应用的现代发展)
    - [12.1 导出Leray谱序列应用](#121-导出leray谱序列应用)
    - [12.2 Leray谱序列应用的应用](#122-leray谱序列应用的应用)
  - [历史与渊源（对齐）](#历史与渊源对齐)
  - [姊妹篇与网络资源](#姊妹篇与网络资源)
