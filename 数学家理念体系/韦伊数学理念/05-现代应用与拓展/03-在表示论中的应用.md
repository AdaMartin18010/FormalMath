...
- [韦伊思想在表示论中的应用](#韦伊思想在表示论中的应用)
  - [📋 目录](../README.md#目录)
  - [一、拓扑群表示论](../README.md#一、拓扑群表示论)
    - [1.0 韦伊思想在表示论中的应用网络图](../README.md#1.0-韦伊思想在表示论中的应用网络图)
    - [1.1 韦伊的贡献](../README.md#1.1-韦伊的贡献)
    - [1.2 表示论方法](../README.md#1.2-表示论方法)
  - [二、在Langlands纲领中的应用](../README.md#二、在langlands纲领中的应用)
    - [2.1 Langlands对应](../README.md#2.1-langlands对应)
    - [2.2 现代实现](../README.md#2.2-现代实现)
  - [三、几何Langlands纲领](../README.md#三、几何langlands纲领)
    - [3.1 几何化](../README.md#3.1-几何化)
    - [3.2 现代发展](../README.md#3.2-现代发展)
  - [四、2024-2025最新进展](../README.md#四、2024-2025最新进展)
    - [4.1 几何Langlands纲领](../README.md#4.1-几何langlands纲领)
    - [4.2 凝聚数学](../README.md#4.2-凝聚数学)
