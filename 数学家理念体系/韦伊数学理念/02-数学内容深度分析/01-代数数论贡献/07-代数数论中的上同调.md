...
- **在类域论中的应用**：类域论可以通过Galois上同调表述
  ...
  - Artin互反律可以通过上同调构造
  - 统一的表述适用于数域与函数域
- **在Langlands纲领中的应用**：Galois表示与上同调密切代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - Galois表示与上同调密切代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - 在Langlands对应中起关键作用
  - 为现代数论提供基础
...
- **Langlands对应**：Langlands对应连接Galois表示和自守表示，上同调在其中起关键作用
  - Galois表示与上同调密切代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - 自守表示与上同调密切代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - 上同调在Langlands对应中起关键作用
- **Galois表示**：Galois表示与上同调密切代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - Galois表示 $\rho: \text{Gal}(\bar{K}/K) \to \text{GL}_n(\mathbb{C})$ 与上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - 通过上同调研究Galois表示
  - 在Langlands对应中起关键作用
- **自守表示**：自守表示与上同调密切代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - 自守表示 $\pi$ 与上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - 通过上同调研究自守表示
  - 在Langlands对应中起关键作用
...
- **Galois表示的上同调**：通过Galois表示构造上同调
  - Galois表示 $\rho$ 定义 $\mathbb{C}^n$ 上的 $\text{Gal}(\bar{K}/K)$ 作用
  - 通过这个作用，$\mathbb{C}^n$ 成为 $\text{Gal}(\bar{K}/K)$-模
  - 上同调 $H^n(\text{Gal}(\bar{K}/K), \rho)$ 反映Galois表示的性质
- **在Langlands纲领中的应用**：上同调在Langlands纲领中起关键作用
  - 上同调研究Galois表示
  - 在Langlands对应中起关键作用
  - 为现代数论提供基础
...
- **L函数**：L函数在Langlands对应中起关键作用
  - $L(s, \rho) = L(s, \pi)$
  - 上同调与L函数密切代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调代数数论中的上同调相关
  - 在Langlands对应中起关键作用
