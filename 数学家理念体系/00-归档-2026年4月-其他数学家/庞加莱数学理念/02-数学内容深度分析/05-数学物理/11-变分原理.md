...
$$\delta J = \int_a^b \left(\frac{\partial F}{\partial y} - \frac{d}{dx}\frac{\partial F}{\partial y'}\right)\delta y dx + \left[\frac{\partial F}{\partial y'}\delta y\right]_a^b = 0$$
...
$$L = \frac{1}{2}m\dot{q}^2 - \frac{1}{2}kq^2, \quad S = \int_{t_1}^{t_2} \left(\frac{1}{2}m\dot{q}^2 - \frac{1}{2}kq^2\right) dt$$
